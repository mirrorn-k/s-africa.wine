...
class EccubeDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Plugin\\TaxManagement\\Controller\\Admin\\ConfigController' => 'getConfigControllerService.php',
            'Plugin\\TaxManagement\\Event' => 'getEventService.php',
            'Plugin\\TaxManagement\\Form\\Type\\Admin\\ConfigType' => 'getConfigTypeService.php',
            'Plugin\\TaxManagement\\Repository\\ConfigRepository' => 'getConfigRepositoryService.php',
            ...
            'security.request_matcher.oikmbmp' => 'getSecurity_RequestMatcher_OikmbmpService.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.oikmbmp' => true,
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/app/Plugin/CategoryExtensionB/Entity')]), 'Plugin\\CategoryExtensionB\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/app/Plugin/SSProductDetailPage/Entity')]), 'Plugin\\SSProductDetailPage\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/app/Plugin/TaxManagement/Entity')]), 'Plugin\\TaxManagement\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Repository\\AuthorityRoleRepository' => function () {
            ...
            return ${($_ = isset($this->services['Plugin\\TaxManagement\\Repository\\ConfigRepository']) ? $this->services['Plugin\\TaxManagement\\Repository\\ConfigRepository'] : $this->load('getConfigRepositoryService.php')) && false ?: '_'};
        }])));
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.oikmbmp']) ? $this->services['security.request_matcher.oikmbmp'] : ($this->services['security.request_matcher.oikmbmp'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
