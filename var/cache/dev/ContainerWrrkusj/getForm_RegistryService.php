...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 8), 'Eccube\\Form\\Type\\Admin\\CategoryType' => new RewindableGenerator(function () {
    ...
    yield 0 => ${($_ = isset($this->services['Plugin\\SSProductDetailPage\\Form\\Extension\\ProductTypeExtension']) ? $this->services['Plugin\\SSProductDetailPage\\Form\\Extension\\ProductTypeExtension'] : $this->load('getProductTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\SearchProductType' => new RewindableGenerator(function () {
