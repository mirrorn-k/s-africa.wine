...
class Layout extends \Eccube\Entity\Layout implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'BlockPositions', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'PageLayouts', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'DeviceType', '' . "\0" . 'Eccube\\Entity\\Layout' . "\0" . 'ProductLayouts'];
        }
