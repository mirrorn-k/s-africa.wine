...
/* Block/logo.twig */
class __TwigTemplate_1e4c3c6adfc78d48e6931fdbfb0405ee51e862f46dbfe06c6ae657e2d8fcba2d extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ec-headerRole__title\">
        ...
        echo "-->
                        <img src=\"";
        // line 18
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("/html/user_data/upload/img/pl_logo.png"), "html", null, true);
        echo "\" alt=\"";
    ...
    {
        return array (  58 => 18,  54 => 17,  50 => 16,  43 => 11,);
    }
        ...
        <div class=\"ec-headerTitle\">
            <div class=\"ec-headerTitle__title\">
                <h1>
                    <a href=\"{{ url('homepage') }}\">
                       <!--{{ BaseInfo.shop_name }}-->
                        <img src=\"{{ asset('/html/user_data/upload/img/pl_logo.png') }}\" alt=\"{{ BaseInfo.shop_name }}\">
                    </a>
                </h1>
            </div>
        </div>
    </div>
</div>", "Block/logo.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/logo.twig");
    }
}
