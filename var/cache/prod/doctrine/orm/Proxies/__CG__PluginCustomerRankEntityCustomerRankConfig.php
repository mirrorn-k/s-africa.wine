 ...
 */
class CustomerRankConfig extends \Plugin\CustomerRank\Entity\CustomerRankConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerRankConfig' . "\0" . 'name', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerRankConfig' . "\0" . 'value'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerRankConfig $proxy) {
