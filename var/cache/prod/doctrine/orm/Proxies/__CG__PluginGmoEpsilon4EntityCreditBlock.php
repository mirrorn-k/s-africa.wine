 ...
 */
class CreditBlock extends \Plugin\GmoEpsilon4\Entity\CreditBlock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\GmoEpsilon4\\Entity\\CreditBlock' . "\0" . 'id', '' . "\0" . 'Plugin\\GmoEpsilon4\\Entity\\CreditBlock' . "\0" . 'ip_address', '' . "\0" . 'Plugin\\GmoEpsilon4\\Entity\\CreditBlock' . "\0" . 'block_date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CreditBlock $proxy) {
    ...
    public function getBlockDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBlockDate', []);

        return parent::getBlockDate();
    }
    ...
    public function setBlockDate($block_date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBlockDate', [$block_date]);

        return parent::setBlockDate($block_date);
    }
