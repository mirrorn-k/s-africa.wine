...
class Order extends \Eccube\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'pre_order_id', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'order_no', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'message', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'name01', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'name02', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'kana01', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'kana02', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'company_name', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'email', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'phone_number', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'postal_code', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'addr01', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'addr02', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'birth', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'subtotal', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'discount', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'delivery_fee_total', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'charge', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'tax', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'total', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'payment_total', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'payment_method', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'note', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'order_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'payment_date', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'currency_code', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'complete_message', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'complete_mail_message', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'OrderItems', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Shippings', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'MailHistories', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Customer', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Country', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Pref', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Sex', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Job', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'Payment', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'DeviceType', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'CustomerOrderStatus', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'OrderStatusColor', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'OrderStatus', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'add_point', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'use_point', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . '_calc_customer_rank', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'present_customer_rank_name', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'customer_rank_id', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'customer_rank_name', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'trans_code', '' . "\0" . 'Eccube\\Entity\\Order' . "\0" . 'gmo_epsilon_order_no'];
        }
  ...
  3 => 'AnnotationReader',
    ...
    public function _calc_customer_rank()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, '_calc_customer_rank', []);

        return parent::_calc_customer_rank();
    }
    ...
    public function getPresentCustomerRankName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPresentCustomerRankName', []);

        return parent::getPresentCustomerRankName();
    }
    ...
    public function setCustomerRankId($customerRankId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomerRankId', [$customerRankId]);

        return parent::setCustomerRankId($customerRankId);
    }
    ...
    public function getCustomerRankId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCustomerRankId', []);

        return parent::getCustomerRankId();
    }
    ...
    public function setCustomerRankName($customerRankName)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomerRankName', [$customerRankName]);

        return parent::setCustomerRankName($customerRankName);
    }
    ...
    public function getCustomerRankName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCustomerRankName', []);

        return parent::getCustomerRankName();
    }
    ...
    public function setTransCode($transCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTransCode', [$transCode]);

        return parent::setTransCode($transCode);
    }
    ...
    public function getTransCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTransCode', []);

        return parent::getTransCode();
    }
    ...
    public function getGmoEpsilonOrderNo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGmoEpsilonOrderNo', []);

        return parent::getGmoEpsilonOrderNo();
    }
    ...
    public function setGmoEpsilonOrderNo($gmo_epsilon_order_no = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGmoEpsilonOrderNo', [$gmo_epsilon_order_no]);

        return parent::setGmoEpsilonOrderNo($gmo_epsilon_order_no);
    }
