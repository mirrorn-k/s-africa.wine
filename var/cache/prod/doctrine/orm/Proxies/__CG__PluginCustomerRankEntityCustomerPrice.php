 ...
 */
class CustomerPrice extends \Plugin\CustomerRank\Entity\CustomerPrice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerPrice' . "\0" . 'id', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerPrice' . "\0" . 'CustomerRank', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerPrice' . "\0" . 'ProductClass', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerPrice' . "\0" . 'price'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerPrice $proxy) {
