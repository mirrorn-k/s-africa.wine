...
class Category extends \Eccube\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'hierarchy', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'sort_no', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'ProductCategories', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'Children', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'Parent', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'Creator', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'header_contents', '' . "\0" . 'Eccube\\Entity\\Category' . "\0" . 'footer_contents'];
        }
  ...
  3 => 'AnnotationReader',
    ...
    public function getHeaderContents()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHeaderContents', []);

        return parent::getHeaderContents();
    }
    ...
    public function setHeaderContents($header_contents)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHeaderContents', [$header_contents]);

        return parent::setHeaderContents($header_contents);
    }
    ...
    public function getFooterContents()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFooterContents', []);

        return parent::getFooterContents();
    }
    ...
    public function setFooterContents($footer_contents)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFooterContents', [$footer_contents]);

        return parent::setFooterContents($footer_contents);
    }
