...
namespace Proxies\__CG__\Plugin\SSProductDetailPage\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ProductLayout extends \Plugin\SSProductDetailPage\Entity\ProductLayout implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\SSProductDetailPage\\Entity\\ProductLayout' . "\0" . 'product_id', '' . "\0" . 'Plugin\\SSProductDetailPage\\Entity\\ProductLayout' . "\0" . 'layout_id', '' . "\0" . 'Plugin\\SSProductDetailPage\\Entity\\ProductLayout' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\SSProductDetailPage\\Entity\\ProductLayout' . "\0" . 'Product', '' . "\0" . 'Plugin\\SSProductDetailPage\\Entity\\ProductLayout' . "\0" . 'Layout'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductLayout $proxy) {
    ...
    public function setLayoutId(int $layout_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLayoutId', [$layout_id]);

        return parent::setLayoutId($layout_id);
    }
