 ...
 */
class ConfigStatus extends \Plugin\CustomerRank\Entity\ConfigStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\ConfigStatus' . "\0" . 'id', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\ConfigStatus' . "\0" . 'OrderStatus'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConfigStatus $proxy) {
