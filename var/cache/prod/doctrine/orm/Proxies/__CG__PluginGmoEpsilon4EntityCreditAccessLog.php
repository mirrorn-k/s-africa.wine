 ...
 */
class CreditAccessLog extends \Plugin\GmoEpsilon4\Entity\CreditAccessLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\GmoEpsilon4\\Entity\\CreditAccessLog' . "\0" . 'id', '' . "\0" . 'Plugin\\GmoEpsilon4\\Entity\\CreditAccessLog' . "\0" . 'ip_address', '' . "\0" . 'Plugin\\GmoEpsilon4\\Entity\\CreditAccessLog' . "\0" . 'access_date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CreditAccessLog $proxy) {
    ...
    public function getAccessDate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAccessDate', []);

        return parent::getAccessDate();
    }
    ...
    public function setAccessDate($access_date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAccessDate', [$access_date]);

        return parent::setAccessDate($access_date);
    }
