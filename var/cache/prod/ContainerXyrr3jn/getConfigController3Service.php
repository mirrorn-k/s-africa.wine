...
// Returns the public 'Plugin\TaxManagement\Controller\Admin\ConfigController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/TaxManagement/Controller/Admin/ConfigController.php';

$this->services['Plugin\\TaxManagement\\Controller\\Admin\\ConfigController'] = $instance = new \Plugin\TaxManagement\Controller\Admin\ConfigController(${($_ = isset($this->services['Plugin\\TaxManagement\\Repository\\ConfigRepository']) ? $this->services['Plugin\\TaxManagement\\Repository\\ConfigRepository'] : $this->load('getConfigRepository3Service.php')) && false ?: '_'});
