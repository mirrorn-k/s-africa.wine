...
include_once $this->targetDirs[3].'/app/Plugin/CustomerRank/Service/PurchaseFlow/Processor/DeliveryFeeFreeForCustomerRankPreprocessor.php';
...
$instance->addItemHolderPreprocessor(new \Plugin\CustomerRank\Service\PurchaseFlow\Processor\DeliveryFeeFreeForCustomerRankPreprocessor(${($_ = isset($this->services['Plugin\\CustomerRank\\Service\\CustomerRankService']) ? $this->services['Plugin\\CustomerRank\\Service\\CustomerRankService'] : $this->load('getCustomerRankServiceService.php')) && false ?: '_'}));
