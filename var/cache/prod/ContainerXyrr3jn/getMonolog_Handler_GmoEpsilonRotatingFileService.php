...
// Returns the private 'monolog.handler.gmo_epsilon_rotating_file' shared service.

$this->services['monolog.handler.gmo_epsilon_rotating_file'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'/log/prod/gmo_epsilon.log'), 60, 100, true, NULL);
