...
return $this->services['eccube.purchase.flow.cart.item_validators'] = new \Doctrine\Common\Collections\ArrayCollection([0 => ${($_ = isset($this->services['Eccube\\Service\\PurchaseFlow\\Processor\\DeliverySettingValidator']) ? $this->services['Eccube\\Service\\PurchaseFlow\\Processor\\DeliverySettingValidator'] : $this->load('getDeliverySettingValidatorService.php')) && false ?: '_'}, 1 => ${($_ = isset($this->services['Eccube\\Service\\PurchaseFlow\\Processor\\ProductStatusValidator']) ? $this->services['Eccube\\Service\\PurchaseFlow\\Processor\\ProductStatusValidator'] : ($this->services['Eccube\\Service\\PurchaseFlow\\Processor\\ProductStatusValidator'] = new \Eccube\Service\PurchaseFlow\Processor\ProductStatusValidator())) && false ?: '_'}, 2 => new \Eccube\Service\PurchaseFlow\Processor\StockValidator(), 3 => new \Eccube\Service\PurchaseFlow\Processor\SaleLimitValidator()]);
