...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Plugin\\CustomerRank\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\ConfigType'] : ($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\ConfigType'] = new \Plugin\CustomerRank\Form\Type\Admin\ConfigType())) && false ?: '_'};
}, 'Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankDesignType' => function () {
    return ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankDesignType']) ? $this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankDesignType'] : ($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankDesignType'] = new \Plugin\CustomerRank\Form\Type\Admin\CustomerRankDesignType())) && false ?: '_'};
}, 'Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankType' => function () {
    return ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankType']) ? $this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankType'] : ($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerRankType'] = new \Plugin\CustomerRank\Form\Type\Admin\CustomerRankType())) && false ?: '_'};
}, 'Plugin\\GmoEpsilon4\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\GmoEpsilon4\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\GmoEpsilon4\\Form\\Type\\Admin\\ConfigType'] : $this->load('getConfigType2Service.php')) && false ?: '_'};
}, 'Plugin\\GmoEpsilon4\\Form\\Type\\ConvenienceType' => function () {
    return ${($_ = isset($this->services['Plugin\\GmoEpsilon4\\Form\\Type\\ConvenienceType']) ? $this->services['Plugin\\GmoEpsilon4\\Form\\Type\\ConvenienceType'] : $this->load('getConvenienceTypeService.php')) && false ?: '_'};
}, 'Plugin\\Recommend4\\Form\\Type\\RecommendProductType' => function () {
    return ${($_ = isset($this->services['Plugin\\Recommend4\\Form\\Type\\RecommendProductType']) ? $this->services['Plugin\\Recommend4\\Form\\Type\\RecommendProductType'] : $this->load('getRecommendProductTypeService.php')) && false ?: '_'};
...
}, 'Plugin\\SitemapXmlGenerator\\Form\\Type\\Admin\\SitemapSettingType' => function () {
    return ${($_ = isset($this->services['Plugin\\SitemapXmlGenerator\\Form\\Type\\Admin\\SitemapSettingType']) ? $this->services['Plugin\\SitemapXmlGenerator\\Form\\Type\\Admin\\SitemapSettingType'] : ($this->services['Plugin\\SitemapXmlGenerator\\Form\\Type\\Admin\\SitemapSettingType'] = new \Plugin\SitemapXmlGenerator\Form\Type\Admin\SitemapSettingType())) && false ?: '_'};
}, 'Plugin\\TaxManagement\\Form\\Type\\Admin\\ConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\TaxManagement\\Form\\Type\\Admin\\ConfigType']) ? $this->services['Plugin\\TaxManagement\\Form\\Type\\Admin\\ConfigType'] : ($this->services['Plugin\\TaxManagement\\Form\\Type\\Admin\\ConfigType'] = new \Plugin\TaxManagement\Form\Type\Admin\ConfigType())) && false ?: '_'};
...
}, 7), 'Eccube\\Form\\Type\\Admin\\CategoryType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CategoryExtensionB\\Form\\Extension\\CategoryTypeExtension']) ? $this->services['Plugin\\CategoryExtensionB\\Form\\Extension\\CategoryTypeExtension'] : $this->load('getCategoryTypeExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\CustomerType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminCustomerExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminCustomerExtension'] : ($this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminCustomerExtension'] = new \Plugin\CustomerRank\Form\Extension\AdminCustomerExtension())) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\SearchCustomerType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminSearchCustomerExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminSearchCustomerExtension'] : $this->load('getAdminSearchCustomerExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\SearchOrderType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminSearchOrderExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\AdminSearchOrderExtension'] : $this->load('getAdminSearchOrderExtensionService.php')) && false ?: '_'};
}, 1), 'Plugin\\MailMagazine4\\Form\\Type\\MailMagazineType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\MailMagazineExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\MailMagazineExtension'] : $this->load('getMailMagazineExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductClassEditType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\ProductClassEditExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\ProductClassEditExtension'] : $this->load('getProductClassEditExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Admin\\ProductClassType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\ProductClassExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\ProductClassExtension'] : $this->load('getProductClassExtensionService.php')) && false ?: '_'};
}, 1), 'Eccube\\Form\\Type\\Shopping\\OrderType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Plugin\\GmoEpsilon4\\Form\\Extension\\ConveniExtention']) ? $this->services['Plugin\\GmoEpsilon4\\Form\\Extension\\ConveniExtention'] : $this->load('getConveniExtentionService.php')) && false ?: '_'};
    ...
    yield 1 => ${($_ = isset($this->services['Plugin\\SSProductDetailPage\\Form\\Extension\\ProductTypeExtension']) ? $this->services['Plugin\\SSProductDetailPage\\Form\\Extension\\ProductTypeExtension'] : $this->load('getProductTypeExtensionService.php')) && false ?: '_'};
}, 2), 'Eccube\\Form\\Type\\SearchProductType' => new RewindableGenerator(function () {
    yield 0 => ${($_ = isset($this->services['Customize\\Form\\Extension\\SearchProductTypeExtension']) ? $this->services['Customize\\Form\\Extension\\SearchProductTypeExtension'] : ($this->services['Customize\\Form\\Extension\\SearchProductTypeExtension'] = new \Customize\Form\Extension\SearchProductTypeExtension())) && false ?: '_'};
