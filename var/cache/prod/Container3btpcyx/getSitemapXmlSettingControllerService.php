...
// Returns the public 'Plugin\SitemapXmlGenerator\Controller\Admin\Content\SitemapXmlSettingController' shared autowired service.
...
include_once $this->targetDirs[3].'/app/Plugin/SitemapXmlGenerator/Controller/Admin/Content/SitemapXmlSettingController.php';

$this->services['Plugin\\SitemapXmlGenerator\\Controller\\Admin\\Content\\SitemapXmlSettingController'] = $instance = new \Plugin\SitemapXmlGenerator\Controller\Admin\Content\SitemapXmlSettingController(${($_ = isset($this->services['Plugin\\SitemapXmlGenerator\\Service\\SitemapXmlService']) ? $this->services['Plugin\\SitemapXmlGenerator\\Service\\SitemapXmlService'] : $this->load('getSitemapXmlServiceService.php')) && false ?: '_'});
