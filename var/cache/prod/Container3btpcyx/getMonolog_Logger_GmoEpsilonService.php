...
// Returns the public 'monolog.logger.gmo_epsilon' shared service.

$this->services['monolog.logger.gmo_epsilon'] = $instance = new \Symfony\Bridge\Monolog\Logger('gmo_epsilon');
...
$instance->pushHandler(${($_ = isset($this->services['monolog.handler.gmo_epsilon']) ? $this->services['monolog.handler.gmo_epsilon'] : $this->load('getMonolog_Handler_GmoEpsilonService.php')) && false ?: '_'});
