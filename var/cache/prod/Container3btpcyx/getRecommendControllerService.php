...
include_once $this->targetDirs[3].'/app/Plugin/Recommend4/Controller/RecommendController.php';
include_once $this->targetDirs[3].'/app/Plugin/Recommend4/Service/RecommendService.php';

$a = ${($_ = isset($this->services['Plugin\\Recommend4\\Repository\\RecommendProductRepository']) ? $this->services['Plugin\\Recommend4\\Repository\\RecommendProductRepository'] : $this->load('getRecommendProductRepositoryService.php')) && false ?: '_'};
