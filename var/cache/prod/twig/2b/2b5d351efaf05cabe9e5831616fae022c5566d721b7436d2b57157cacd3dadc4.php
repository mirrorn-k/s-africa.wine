...
/* __string_template__1319b2b6b449c373189c8345c17014b7e9c6c7b095680b31276bd2dc9d631f6f */
class __TwigTemplate_96081cd8d92bded9aaa7a4b934a57f4c8e929d779d2fbcad2589709840eb2ff7 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Longridge Cabernet Sauvignon</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>特徴：</th>
            <td>オーガニック＆ビオディナミ生産者</td>
        </tr>
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2018’] 2015VT：93 Point<br>
[Tim Atkin Report 2017’] 2014VT：92 Point<br>
[Platter SA 2018’] 2015VT：3.5 STAR
            </td>
        </tr>
...
早朝の涼しい時間に収穫。ベストのブドウのみを選果。ステンレスタンクで天然発酵後、プレス。その後フレンチオークに移して熟成22-24ヵ月。<br>赤系果実、ダークチェリー、タバコなどの香り。フレッシュで豊かな酸、ボディは中庸、優しくて心地良い渋み。酸と果実味のバランスが良く、ドライでなめらかな味わい。繊細でシルキーなタッチ、全体にエレガントにまとまっている。ステレンボシュ地区では最も冷涼なヘルダーバーグらしい酸とのバランスが取れた優しいなめらかなスタイルのカベルネ。提供する前にデカンタをお薦めする。<br>ローストビーフ、牛ステーキ、和食など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__1319b2b6b449c373189c8345c17014b7e9c6c7b095680b31276bd2dc9d631f6f";
    }
    ...
    {
        return new Source("", "__string_template__1319b2b6b449c373189c8345c17014b7e9c6c7b095680b31276bd2dc9d631f6f", "");
    }
}
