...
/* __string_template__e61035f01e598bec6fe91f72eff82722859fb8671cc6c90d2dbc3b3b15acfafd */
class __TwigTemplate_4110314831aace4ac8ccca172bf4b8be03487e90bcfe950a2a4e393790d56367 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellar Running Duck Non Sulpher Added White</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
ステンレスタンクで発酵、熟成。ボトリングの際に窒素ガスを注入して酸化を防いでいる。グレープフルーツ、ピーチなどの香り。優しい柔らかな酸とボディ。フレッシュでフルーティ、ジューシーな味わい。なめらかで、酸とのバランスも心地良く、優しい口あたりで飲みやすい。クリスピーなフィニッシュ。<br>シーフード、鶏肉・豚肉料理、和食、寿司、アジア系料理、中華料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__e61035f01e598bec6fe91f72eff82722859fb8671cc6c90d2dbc3b3b15acfafd";
    }
    ...
    {
        return new Source("", "__string_template__e61035f01e598bec6fe91f72eff82722859fb8671cc6c90d2dbc3b3b15acfafd", "");
    }
}
