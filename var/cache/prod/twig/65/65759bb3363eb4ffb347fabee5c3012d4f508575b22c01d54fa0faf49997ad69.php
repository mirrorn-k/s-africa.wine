...
/* Block/bellingham.twig */
class __TwigTemplate_3545501afa33e671b669d22478951e1a26fa11186a4c2c708b02a20e9ff81937 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-9\">
            ...
            <h3 class=\"ltx_15 tx_bld\">
300年以上の歴史を持つワイナリー</h3>
            <p class=\"m_5\">ベリンガムは1693年に設立された300年を超える歴史あるワイナリー。 ベリンガムとは「美しい畑」という意味。<br>卓越した技術力と商品開発力で、幾つかのブランドを所有しているが、創業者バーナードの名前を冠にした同社のトップレンジ「バーナード・シリーズ」は、数々のメダルやトップ評価を勝ち取るなど、南アフリカ屈指のワイナリーの1つに成長している。</p>
        </div>
        ";
                        }
                        // line 21
    ...
    {
        return new Source("", "Block/bellingham.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/bellingham.twig");
    }
}
