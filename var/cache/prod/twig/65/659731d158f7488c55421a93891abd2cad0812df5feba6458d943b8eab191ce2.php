...
/* __string_template__69c06525ba134cfdbc627bd90376375a4b54e39c1de096c6340d249a26c66602 */
class __TwigTemplate_9e51d0a119da7407ae05bb01a039629c1bd944af474b7d99986b31905c68e372 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Peacock Wild Ferment Cabernet Sauvinon</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
周辺の畑で、収穫量の少ない良質のブドウを購入。収穫後は除梗せず、ソフトにプレス。600L古いフレンチオークと、大きな古いオークカスクで天然発酵＆熟成6ヶ月。軽くフィルターをして瓶詰め。少量のＳＯ２以外何も使用しない不干渉主義な製法。<br>赤系ベリー、カシス、カカオなどの香り。フレッシュで豊かな酸味、細やかな渋みがワインに溶けこみ、なめらかな味わい。程良い柔らかなボディ。そのままでも美味しく、料理とのマッチングも良い。不干渉主義。<br>ピーコックという名は、ウォータークルーフの敷地内および周辺にはクジャクが生息していることから名付けられた。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__69c06525ba134cfdbc627bd90376375a4b54e39c1de096c6340d249a26c66602";
    }
    ...
    {
        return new Source("", "__string_template__69c06525ba134cfdbc627bd90376375a4b54e39c1de096c6340d249a26c66602", "");
    }
}
