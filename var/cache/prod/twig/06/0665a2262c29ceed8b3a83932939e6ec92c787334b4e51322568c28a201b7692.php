...
class __TwigTemplate_97c534cfa30f950be54b5d6a54507789493a837b0b34da7a3e7212f6cc400998 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
            ...
            <table id=\"html-mail-table1\" border=\"0\" width=\"600px\" cellpadding=\"10\" cellspacing=\"0\" class=\"container\" style=\"border-spacing:0;mso-table-lspace:0pt;mso-table-rspace:0pt;\">
                <tr>
                    <td class=\"container-padding content\" align=\"left\" style=\"border-collapse:collapse;padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff;\">
                        <br>
                        <div class=\"title\" style=\"font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550;\">この度は会員登録依頼をいただきまして、<br/>有り難うございます。</div>
                        <br>
...
<br>
    ...
    {
        return new Source("", "Mail/entry_confirm.html.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Mail/entry_confirm.html.twig");
    }
}
