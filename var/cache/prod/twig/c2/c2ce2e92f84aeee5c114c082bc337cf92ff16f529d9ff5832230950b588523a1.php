...
/* __string_template__542c0e3e69a0c30a80efe442cf66a73992222a0e597778a80ca3c02242d97b4f */
class __TwigTemplate_51a785494520287e2bd2971e6443de685e9d8f16379a1156f31e7d49256ada43 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>David & Nadia Elpidios</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2017’] 2015VT：94 Point<br>
[Tim Atkin Report 2016’] 2014VT：93 Point
            </td>
        </tr>
...
岩、片岩、花崗岩や鉄分豊富な土壌で、スワートランドの7箇所の畑のブドウを使用。収穫量は4-5トン/haと極めて少量。収穫後は、ステンレスタンクで全房と除茎の物を混ぜて天然発酵、トータルでスキンコンタクトは4週間。その後、ソフトにプレスし、500Ｌの古いフレンチオークに移してマロラクティック発酵＆20ヶ月熟成。<br>ラズベリー、クランベリー、スパイス、ラベンダーなどの花の香り。透明感のある綺麗なワインで優しいボディ。美しく豊かな酸味、キメ細やかで洗練された渋み。優しくなめらか、旨みも感じられ、エレガントなフィニッシュ。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__542c0e3e69a0c30a80efe442cf66a73992222a0e597778a80ca3c02242d97b4f";
    }
    ...
    {
        return new Source("", "__string_template__542c0e3e69a0c30a80efe442cf66a73992222a0e597778a80ca3c02242d97b4f", "");
    }
}
