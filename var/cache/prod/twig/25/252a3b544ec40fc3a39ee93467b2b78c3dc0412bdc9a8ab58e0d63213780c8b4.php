...
/* __string_template__c3dabceada63520a697755373fc7e2e8a3ec5321f731ef6e7f1f7b25146262c0 */
class __TwigTemplate_f552243fb64e4d478bc46804b782ce437b9f46042b8b158a371fdfeef60a53ba extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Bellingham Homestead Sauvignon Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2018’] 2017VT：87 Point
            </td>
        </tr>
...
ベストな畑を西ケープ州から探し、天然発酵で作られる。 手摘みで収穫、ステンレスタンクで16度で低温発酵、そのまま澱（おり）が入ったまま熟成（シュール・リー製法）。<br>メロン、梨、柑橘類などの香り。フレッシュで柔らかな酸味、凝縮した果実味、しっかりと太いボディ。柑橘系やトロピカルフルーツの風味が爆発的なほど豊かで最後まで続く。フィニッシュはクリスピーで、クリーン＆ドライ。豊かな果実味と太い骨格を持ち合わせた、しっかり系ソーヴィニョンブラン。<br>グリルした魚、シーフード、鶏肉など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__c3dabceada63520a697755373fc7e2e8a3ec5321f731ef6e7f1f7b25146262c0";
    }
    ...
    {
        return new Source("", "__string_template__c3dabceada63520a697755373fc7e2e8a3ec5321f731ef6e7f1f7b25146262c0", "");
    }
}
