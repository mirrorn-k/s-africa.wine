...
/* __string_template__d8831c30a819bd7be7f1f4e7e22c38381b25ab3f90485ec5170b526318887a45 */
class __TwigTemplate_7c7d5093d3400d904cddb19b2db0afd2e5c83dcb4b5a682e33226a57f10f9d95 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Raats Eden High Density Single Vineyard Chenin Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
[Platter SA 2018’] 2016VT：5 STAR<br>
...
0.6haの畑で2トン/haと極小。土壌は花崗岩。ラーツの蜜植栽培（1haあたり8000本で1ｘ1.2ｍ間隔で植えている。通常は3000-4000本/ha。）。蜜植にすることによって、ブドウの木が互いに競争し、強いブドウが生育する。２月初旬に収穫。その後、全房でプレス。そのまま300Lのフレンチオークで天然発酵、熟成10ヶ月。<br>ライム、青リンゴ、桃、パイナップル、僅かにジンジャー、白コショウ、花やハチミツ、ローストしたナッツなどの香り。フレッシュで綺麗な酸とミネラルを強く感じ、濃厚で凝縮した果実味。味わいはなめらかで綺麗、複雑味もある。ボディは中庸。余韻は長く、エレガントなフィニッシュで、ジンジャーなどのスパイス感もある。南アフリカを代表する特別なシュナンブランの1本。<br>牡蠣（カキ）、帆立貝他、シーフード、ローストポーク、ソーセージ、中華料理、スパイシーなアジア系料理、ベイクドアップル（デザート）など幅広い料理に合わせやすい。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__d8831c30a819bd7be7f1f4e7e22c38381b25ab3f90485ec5170b526318887a45";
    }
    ...
    {
        return new Source("", "__string_template__d8831c30a819bd7be7f1f4e7e22c38381b25ab3f90485ec5170b526318887a45", "");
    }
}
