...
/* __string_template__e55dfc42d6a7860faac0720bdea70412c337ca190318792f142fa8e50219bb1c */
class __TwigTemplate_c3f3f97529a5a23b5c9a39f63414091061a09d63f70f5ba9ba841757a6b09cf5 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellar Running Duck Non Sulpher Added Shiraz</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Ultra Vulalue Challenge 2018’] 2018VT：Gold<br>
[Real Wine Guide 2019’] 2017VT：旨安大賞
            </td>
        </tr>
...
ステンレスタンクで発酵、熟成。ボトリングの際に窒素ガスを注入して酸化を防いでいる。<br>ダークチェリー、ブラックオリーブ、プラム、スパイス、コショーなどの香り。優しい柔らかな酸とボディ。フレッシュで赤や黒系果実、ブラックオリーブなどの風味のフルーティでジューシーな味わい。渋みは程よい程度で、軽快でなめらか、優しい口あたりで飲みやすい。<br>スペアリブ、ローストチキン、タンドリーチキンやラム、スパイス系料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__e55dfc42d6a7860faac0720bdea70412c337ca190318792f142fa8e50219bb1c";
    }
    ...
    {
        return new Source("", "__string_template__e55dfc42d6a7860faac0720bdea70412c337ca190318792f142fa8e50219bb1c", "");
    }
}
