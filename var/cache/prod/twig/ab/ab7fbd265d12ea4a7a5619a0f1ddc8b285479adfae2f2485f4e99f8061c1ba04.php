...
/* Block/namaqua.twig */
class __TwigTemplate_ecb4b5093c39b47c691cb6900130a6299c1237abc02b65956f0cc510a7af2b4d extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-9\">
            ...
            <h3 class=\"ltx_15 tx_bld\">
「最初」を意味するワイン</h3>
            <p class=\"m_5\">1947年設立、北ケープ州・ナマクワ地区にあり、高品質な低価格ワインを生産・販売することを得意としているワイナリー。南アフリカで最も多くワインを輸出している代表的な会社の一つ。<br>世界一のワイン市場イギリスでは、ナマクワ社のワインは南アフリカのワインとしては市場でトップ3に入っている。</p>
        </div>
        ";
                        }
                        // line 21
    ...
    {
        return new Source("", "Block/namaqua.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/namaqua.twig");
    }
}
