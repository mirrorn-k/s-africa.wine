...
/* __string_template__2d85466a543d2c6577549216c7e2bcb5d826fc8a9bbb4d6cf4796a6552c290b9 */
class __TwigTemplate_4dc9987f59c63e2af057897387510c093e2d8c68e555f6d51e9163f538dc75f4 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof The Wolftrap White</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Decanter World Wine Awards 2017’] 2016VT：87 Point／Bronze<br>
[Platter SA 2020’] 2018VT：4 STAR<br>
...
それぞれの品種で発酵。シュナンブランとグルナッシュブランはフレンチオークを使用して熟成。その後ブレンド。濾過して瓶詰。アーモンド、りんごの花、スパイスなどの豊な香り。やさしい酸味、凝縮した果実味、なめらかでコクのある味わい。それぞれの品種の要素がこのワインを複雑な面白いワインに仕上げている。オークの風味もあり、フィニッシュはクリーンで余韻も長い。<br>お勧め料理：シーフード、パスタ、中華料理、アジア料理など。<br>
<br>
過去の謎と伝説を思い出すワイン<br>
18世紀頃ヨーロッパの植民者達がブーケンハーツクルーフのあるフランシュック谷に住み始めた。彼らは当時、山にオオカミが住んでいると信じて「ウルフトラップ（狼のワナ）」を仕掛けたが、実際にはオオカミは居なかったという話からこのワインに名付けられた。
    ...
    {
        return "__string_template__2d85466a543d2c6577549216c7e2bcb5d826fc8a9bbb4d6cf4796a6552c290b9";
    }
    ...
    {
        return new Source("", "__string_template__2d85466a543d2c6577549216c7e2bcb5d826fc8a9bbb4d6cf4796a6552c290b9", "");
    }
}
