...
/* __string_template__fc42dc57424e0908fc451353421c473f494d3bbb78b39e78e2fd251fc573e285 */
class __TwigTemplate_c357f809420f861a41e4ae81a9fb02818b4388333243da2407916b64ed901a21 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>David ＆ Nadia Chenin Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
スワートランドの6箇所の畑のブドウを使用。全てブッシュヴァイン（株仕立て）。ブドウの樹齢は35-49年の古木。収穫量は2-4トン/haと極めて少量。収穫後は、全房発酵、天然発酵。３００Ｌの古いフレンチオークで熟成。5120本生産。<br>梨、桃、花の香り、乾燥した土地の埃っぽい香りなど。豊かな酸味、古木＆低い収穫量から由来する凝縮した果実味。ふくよかで程良い厚みとボディ。フレッシュで果実の旨み、ブドウのナチュラルなピュアテイストを楽しめる。酸味と果実味のバランスが良く、素直に美味しく楽しめるワイン。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__fc42dc57424e0908fc451353421c473f494d3bbb78b39e78e2fd251fc573e285";
    }
    ...
    {
        return new Source("", "__string_template__fc42dc57424e0908fc451353421c473f494d3bbb78b39e78e2fd251fc573e285", "");
    }
}
