...
/* __string_template__2a42fea333883b7fdf9cf8410c323a0c7dea7c8f1b58197d0b2082f4a0170bac */
class __TwigTemplate_0f44ceaef7a3012096884c6b2f11e42c97dfb0056d91374137d4e9b547680637 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Glenelly Rose De May</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>ワイナリー直営のレストランのみで販売されていたのを説得。輸出は日本のみ。
            </td>
        </tr>
...
軽く色付くまで優しく全房でプレス。ジュースはステンレスタンクに移して天然発酵。14度の低温で発酵。マロラクティック発酵は無し、そのまま熟成。透明な美しいブラッシュ・ピンク。グラスに注ぐと、ザクロ、キャンディ、フレッシュなラズベリーの香りが豊かに満たされる。<br>フレッシュで豊かな酸。柑橘類やストロベリーなどの風味。エレガントでクリスピーなフィニッシュが最後まで気持ちが良い。フードフレンドリーで、食欲が沸くような気持ちの良い辛口ロゼ。<br>ワイナリー直営のレストランのみで販売されていたのを説得。輸出は日本のみ。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__2a42fea333883b7fdf9cf8410c323a0c7dea7c8f1b58197d0b2082f4a0170bac";
    }
    ...
    {
        return new Source("", "__string_template__2a42fea333883b7fdf9cf8410c323a0c7dea7c8f1b58197d0b2082f4a0170bac", "");
    }
}
