...
/* __string_template__38e842d8463ab8f0c3896e119825d8f9d8bb7aeb334ec973fbdf5003f0b2eb54 */
class __TwigTemplate_db00993ff526284eb823c84d056dbe254f502d863fa711b7c03ddcc3bdfe8d6b extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellenrust Artisons Mothership Chenin Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Platter SA 2019’] 2018VT：5 STAR<br>
[Tim Atkin Report 2019’] 2018VT：95 Point
            </td>
        </tr>
...
ボタラリー・ヒルズのブッシュヴァインの畑で1964年に植樹。分解した花崗岩土壌。収穫後、6-12時間スキンコンタクト。その後、大樽とコンクリートの卵型タンクで天然発酵、そのまま12ヶ月熟成しブレンド。<br>白桃、梨、キャンディなどの香り。豊かな酸、厚みのあるボディ、なめらかでリッチな味わい。フレッシュ＆フルーティ、濃厚な果実味がしっかりした酸に支えられ、バランス良くまとまっている。余韻も長い。他のステレンラストの白ワインと同じく、完熟ブドウの糖度の高い果実の甘みと酸のコントラストが、何処にも無いステレンラストらしい面白さを表現している。<br>酸が効いて美しくエレガント、濃厚さとボディ、ステレンラストのフラグシップ品種であるシュナンブランの総決算のような最高レベルに仕上げられた１本。限定品。<br>シーフード、グリルした魚、クリームソース、タイのグリーンカレー、スパイス料理、アジア系料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__38e842d8463ab8f0c3896e119825d8f9d8bb7aeb334ec973fbdf5003f0b2eb54";
    }
    ...
    {
        return new Source("", "__string_template__38e842d8463ab8f0c3896e119825d8f9d8bb7aeb334ec973fbdf5003f0b2eb54", "");
    }
}
