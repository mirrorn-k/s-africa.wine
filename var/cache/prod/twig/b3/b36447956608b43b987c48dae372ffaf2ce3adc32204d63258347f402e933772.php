...
/* __string_template__c22d6c3ec01dc168edb9513d7a8b6f8922cc6649e32f1ae939d4c9601b520f2f */
class __TwigTemplate_b32507f9019f776f2592a447cad15b2347f3cf90c88f45e9749e405d201c10ae extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Rustenberg Chardonnay</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2020’] 2019VT：92 Point<br>
[Decanter World Wine Awards 2020’] 2019VT：92 Point／Silver<br>
[Decanter World Wine Awards 2019’] 2017VT：91 Point／Silver<br>
...
樹齢15-30年、ブドウはかなり厳選している。畑は標高300-450ｍにあり、冷涼で酸のしっかりしたブドウが育つ。早朝の涼しい時間にブドウを全て手摘みで収穫。収穫後、ステンレスタンクで冷却後、300Lのフレンチオーク（新樽40％、2年目の樽60％）で天然発酵。12ヶ月の熟成を経て瓶詰め。<br>アプリコット、オレンジの皮、柑橘類などの香り。豊かで活き活きとした酸味。繊細で綺麗、なめらかでややクリーミーな味わい。程良いボリューム感もあるエレガント系ワイン。<br>シーフード料理、クリームソースやバターを使った料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__c22d6c3ec01dc168edb9513d7a8b6f8922cc6649e32f1ae939d4c9601b520f2f";
    }
    ...
    {
        return new Source("", "__string_template__c22d6c3ec01dc168edb9513d7a8b6f8922cc6649e32f1ae939d4c9601b520f2f", "");
    }
}
