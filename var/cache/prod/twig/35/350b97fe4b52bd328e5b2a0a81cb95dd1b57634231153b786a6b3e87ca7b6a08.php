...
/* Block/hartenberg.twig */
class __TwigTemplate_aad169b0ea0a0a21f52c66252cd3c5872c80282f5127b3a7da8f138fdcd0dcc3 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-9\">
            ...
            <h3 class=\"ltx_15 tx_bld\">
老舗のプレミアム・ワインの生産者</h3>
            <p class=\"m_5\">1692年設立の南アフリカを代表する老舗かつプレミアム・ワインの生産者。 ワイン作りのコンセプトは、「他にはない、ずば抜けて高品質なワインを作ること」。<br>
南アフリカの生物多様性保護プログラム（BWI）にも参加し、環境にも配慮した経営を行っており、また、社会貢献活動としてPEBBLES（ペブルス：南アフリカの子供の教育支援団体（NGO））の支援も行っている。</p>
        </div>
        ";
                        }
                        // line 22
    ...
    {
        return new Source("", "Block/hartenberg.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/hartenberg.twig");
    }
}
