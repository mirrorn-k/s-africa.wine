...
/* Mypage/login.twig */
class __TwigTemplate_1b6f1f5b3d384c96cc071b0c27c249ebc858247b4bc0450573babcf620f5b81f extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 23), "flashBag", [], "any", false, false, false, 23), "has", [0 => "eccube.login.target.path"], "method", false, false, false, 23)) {
            ...
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 24), "flashBag", [], "any", false, false, false, 24), "get", [0 => "eccube.login.target.path"], "method", false, false, false, 24));
...
";
    ...
    {
        return new Source("", "Mypage/login.twig", "/home/anotherworld/www/s-africa.wine/src/Eccube/Resource/template/default/Mypage/login.twig");
    }
}
