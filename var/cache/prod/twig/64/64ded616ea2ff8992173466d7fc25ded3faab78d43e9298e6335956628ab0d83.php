...
/* __string_template__8b7b0bfc3ee6c6d2de3e04a19e5db2d4e34e814a6b74d2d3ef393ac88f2836c4 */
class __TwigTemplate_1d614a5390d4c6f7806b283f1cfb91b8535acfbc3d7ca06da9221da6b1d525cb extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellenrust Old bushvine Cinsault</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
ボタラリー・ヒルズの風化した花崗岩質の畑で1964年に植樹。2日間コールドマセラシオン後、ブドウの皮と一緒にローヌとボルドーの酵母を使ってコンクリートのオープンタンクで発酵。ブドウの皮と一緒にステンレスタンクに移し7-10日漬け込み、マロラクティック発酵を経て、フレンチオークに移して16ヶ月熟成（新樽10％、残りは2-3年目の樽）。<br>ストロベリー、レッドチェリー、赤系果実、熟した果実、森の土、優しいオークの香り。柔らかな酸とボディ、渋みは優しく細やか。フルーティでシルキー、ピノノワールのような透明感ある綺麗なワイン。古木のブドウ由来の優しい口あたりでエレガントなスタイル。<br>日々飲みたい軽快な心地の良いワイン。15度前後くらいの気持ち冷やして提供するのが良いと思います。<br>焼鳥、和食、焼きそば、中華料理、アジア系料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__8b7b0bfc3ee6c6d2de3e04a19e5db2d4e34e814a6b74d2d3ef393ac88f2836c4";
    }
    ...
    {
        return new Source("", "__string_template__8b7b0bfc3ee6c6d2de3e04a19e5db2d4e34e814a6b74d2d3ef393ac88f2836c4", "");
    }
}
