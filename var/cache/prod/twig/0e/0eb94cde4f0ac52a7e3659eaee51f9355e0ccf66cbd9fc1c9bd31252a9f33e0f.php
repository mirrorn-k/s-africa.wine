...
/* __string_template__d42e25b24a16c49b4078e6dd0e016535d30af6ec27ce9c8b5243c8e6952b41b4 */
class __TwigTemplate_748b3a115e0771c2e11f5a7def94c9f1f17324be82f7fd08a80060a9b63c0e6e extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Reyneke Reserve White</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
リザーブ・ホワイトには、最上のブドウのみを使用。収穫後は全房でプレス。その後、300Lのフレンチオークで天然発酵（95％は新樽、5％は2年目の樽）。そのまま澱が入ったまま12か月熟成。その後、ステンレスタンクに移して更に4か月熟成。飲み頃は2018-2023年。<br>フレッシュで、リンゴ、花、柑橘類の皮、火打石を擦ったような活き活きとした香り。比較的ふくよかで豊かな酸、凝縮した濃厚な果実味で複雑味を帯びている。口あたりは、なめらかで、ほんのりクリーミー。ボディは太くしっかりした骨格。全体のバランスも良く、余韻も長い。南アフリカでは少ない樽熟成した秀逸なソーヴィニョンブランの一つ。<br>サーモン、シーフードマリネ、クリーム系パスタ、蒸し鶏、コンソメスープなど。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__d42e25b24a16c49b4078e6dd0e016535d30af6ec27ce9c8b5243c8e6952b41b4";
    }
    ...
    {
        return new Source("", "__string_template__d42e25b24a16c49b4078e6dd0e016535d30af6ec27ce9c8b5243c8e6952b41b4", "");
    }
}
