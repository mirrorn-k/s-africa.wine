...
/* __string_template__a9153845bc79f71c3bac70876ba376725fd2e90bf9b48570959ce1e4673b857b */
class __TwigTemplate_66eccaadb0c044564d5e48cac193ce37cea07a9d07ca132f5cdbfd2b4343ccdb extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Porcupine Ridge Sauvignon Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Decanter World Wine Awards 2017’] 2016VT：85 Point／Commended<br>
[Decanter World Wine Awards 2016’] 2015VT：86 Point／Bronze
            </td>
        </tr>
...
ロバートソン、ステレンボッシュ産のブドウを主に使用。リンゴの花、メロン、パパイヤなど、トロピカルフルーツを思わせる香りに、活き活きとした爽やかな酸味。フレッシュで、 クリスピーなバランスの良い仕上がり。程よい厚みとやさしい余韻。<br>サラダ、シーフードのマリネ、お寿司など。<br>2009年ヴィンテージは、2009年11月28日のジャンシス・ロビンソンのサイトで「絶対お勧めの世界の白ワイン77本」の1本に選出される。<br>
日々 愛用されるテーブルワインをテーマに、畑の人気者 ハリネズミをモチーフとしている。
    ...
    {
        return "__string_template__a9153845bc79f71c3bac70876ba376725fd2e90bf9b48570959ce1e4673b857b";
    }
    ...
    {
        return new Source("", "__string_template__a9153845bc79f71c3bac70876ba376725fd2e90bf9b48570959ce1e4673b857b", "");
    }
}
