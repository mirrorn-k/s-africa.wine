...
/* __string_template__c29c4d986592f067377193beee4040a5a1ac9ffc852493c8d4398a6e4740fae6 */
class __TwigTemplate_5d163016b14a7b61a692352a84c71794133d21a7aca81cb5068cdb8c3c8570e9 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Reyneke Organic Red</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
4分の1のブドウは自社の畑から、他は他地域のオーガニックの畑から購入。除梗後は、コンクリートタンクとステンレスタンクで天然発酵。25％は、古い樽で8か月熟成させ、最後にブレンド。ヴィンテージ+3年。<br>フレッシュな黒コショウ、カシス、タイム、タバコ、スミレなどの香り。優しい柔らかな酸とボディ。フレッシュで赤系果実やプラムなどのジューシーで軽快な味わい。細やかで活き活きとした渋み、全体のバランスは良くまとまっていて、スムーズでなめらか、優しい口あたりでドライなフィニッシュ。<br>和食、洋食、アジア料理、パスタ、ピザなど幅広く様々な料理に。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__c29c4d986592f067377193beee4040a5a1ac9ffc852493c8d4398a6e4740fae6";
    }
    ...
    {
        return new Source("", "__string_template__c29c4d986592f067377193beee4040a5a1ac9ffc852493c8d4398a6e4740fae6", "");
    }
}
