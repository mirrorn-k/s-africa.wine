...
/* __string_template__883fa3bf752998572b25af06b8b9afefcdef170cf43b0d6816bfcae25f9c5063 */
class __TwigTemplate_4445ed5bb36f48c189dfd1e089a0b58e4651f2eac5946d44d0d20c6a211d4f0c extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Porcupine Ridge Cabernet Sauvignon</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
[Platter SA 2020’] 2018VT：3.5 STAR
            </td>
        </tr>
...
ステレンボッシュ・ヘルダーバーグ地区のブドウを主に使用。ステンレスタンクで発酵後、3分の2をフレンチオークで、残りはステンレスタンクで熟成。少量のカベルネフランをブレンドし、繊細な香がワインに与えられる<br>。鮮やかなルビーレッド、プルーン、イチジク、トリュフ、オークの香り。柔らかな酸味、豊な果実味、適度な渋みと、なめらかな味わい。程よくしっかりとしたボディでバランス良く出来ている。<br>ビーフシチュー、ラム、トマトを使った肉料理など。<br>
日々 愛用されるテーブルワインをテーマに、畑の人気者 ハリネズミをモチーフとしている。
    ...
    {
        return "__string_template__883fa3bf752998572b25af06b8b9afefcdef170cf43b0d6816bfcae25f9c5063";
    }
    ...
    {
        return new Source("", "__string_template__883fa3bf752998572b25af06b8b9afefcdef170cf43b0d6816bfcae25f9c5063", "");
    }
}
