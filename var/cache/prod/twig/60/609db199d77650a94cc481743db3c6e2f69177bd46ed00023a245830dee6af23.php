...
/* __string_template__2510b0c8d481615f281127408c4b6e24fbae4112da4eac090620a5e259b31e78 */
class __TwigTemplate_d5d77c1198c7817843f0071d97be7694b8d621e281fa9f434ec9ea76e79df1a3 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Ataraxia Chardonnay</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>\t[Parker Wine Advocate] 2015VT：93 Point<br>
[Tim Atkin Report 2019’] 2017VT：95 Point<br>
[Tim Atkin Report 2017’] 2016VT：96 Point
            </td>
        </tr>
...
生産量：4366ケース（６入り）栽培・製造：冷涼なケープ・サウスコースト、ハマナスの海の近くのヘメル・アン・アード・リッジ小地区の畑で栽培。畑は頁岩土壌で、粘土質、石の混ざった肥沃でない土地。冷涼気候の為、ブドウのハンギング・タイムが長く、果実味が凝縮する。３月始めの２週間の早朝の涼しい時間に収穫。<br>セラー内では、テロワールを忠実に表現する為に、出来るだけ人の手を加えないミニマリスト的アプローチで製法。<br>100％ブルゴーニュから買い付けた225Lのフレンチオークで発酵＆熟成10ヶ月（新樽21％、2年目樽79％）。<br>グレープフルーツ、白桃、熟した梨、ナッツなどの香り。ミネラル分が豊かでしっかりした酸味、骨格のハッキリしたボディ、凝縮した果実味で、力強さもある。味わいは、複雑でやや濃厚、なめらかでクリーミー。酸味と果実味、ボディ、全てにおいてバランス良くエレガントにまとまっている。ゴージャスかつスタイリッシュ、余韻も長く、クラシックなスタイルのワイン。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__2510b0c8d481615f281127408c4b6e24fbae4112da4eac090620a5e259b31e78";
    }
    ...
    {
        return new Source("", "__string_template__2510b0c8d481615f281127408c4b6e24fbae4112da4eac090620a5e259b31e78", "");
    }
}
