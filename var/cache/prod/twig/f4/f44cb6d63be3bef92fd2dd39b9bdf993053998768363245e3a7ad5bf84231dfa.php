...
/* __string_template__e4e018c545809d5b77e955d3cedd8688ad53099c81f4f5f9d15448be77b31be3 */
class __TwigTemplate_9a3fdbfc64d756d8949d628d5b83fb4837538728c74bdebb3025a1cb1d58dd88 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Reyneke Cornerstone</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>商品特徴：</th>
            <td>労働者の生活向上や子供たちの教育支援を行っているアイテム</td>
        </tr>
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2017’] 2014VT：93 Point<br>
...
ビオディナミ農法で育てられたブドウを畑でセレクションし、また、セラーでも更に一粒一粒セレクションし、ベストのブドウだけを使用。ブドウはコンクリートタンクで発酵、フレンチオークに移して18か月熟成（新樽30％、2年目、3年目の樽70％使用）。その後、バレルセレクションし、ブレンドしてタンクで4か月熟成し、瓶詰。ヴィンテージ+7-10年。<br>カシス、黒系果実、スパイス、タバコの葉、鉛筆の芯などミネラリーな香り。フレッシュで心地良い酸、凝縮した果実の味わい、まっすぐでやや太く、はっきりとした輪郭のボディ。細やかでしっかりとした渋みを感じるが、口あたりはなめらか。全体にバランス良くまとまっている優等生的な仕上がり。<br>牛ステーキ、ローストしたラム肉、ミートソースやトマトソースのパスタ、酢豚など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__e4e018c545809d5b77e955d3cedd8688ad53099c81f4f5f9d15448be77b31be3";
    }
    ...
    {
        return new Source("", "__string_template__e4e018c545809d5b77e955d3cedd8688ad53099c81f4f5f9d15448be77b31be3", "");
    }
}
