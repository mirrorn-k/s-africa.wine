...
/* __string_template__9e8654f6bf740d20eaf2d79cafd1769998f290496991f2a0b5c8b89cc7462e23 */
class __TwigTemplate_e55985816499a94e2b231d2cfddb2869a96e0d74815750f92f0591c56c28fcd5 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Porcupine Ridge Chenin Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Platter SA 2020’] 2018VT：3.5 STAR
            </td>
        </tr>
...
2019年は日中も暑すぎず、夜は冷涼な気温で理想的なコンディションだった。発酵、熟成を経てブレンド。フレッシュなライム、グリーンメロン、パッションフルーツ、グアヴァ、パイナップル、カリン、グリーンイチジクなど複雑な香り。フレッシュで柔らかな酸味、フルーティな果実味、程よく厚みのあるボディがバランスが良く出来ている。暖かい南国フルーツの風味と乾燥したスワートランドらしいドライなテイスト、チョーキーなミネラルが表現されている。もちろんブーケンハーツクルーフらしい、コストパフォーマンスに優れたワインに仕上がっている。<br>シーフード、鶏肉、豚肉、中華・アジア系料理など。<br>
日々 愛用されるテーブルワインをテーマに、畑の人気者 ハリネズミをモチーフとしている。
    ...
    {
        return "__string_template__9e8654f6bf740d20eaf2d79cafd1769998f290496991f2a0b5c8b89cc7462e23";
    }
    ...
    {
        return new Source("", "__string_template__9e8654f6bf740d20eaf2d79cafd1769998f290496991f2a0b5c8b89cc7462e23", "");
    }
}
