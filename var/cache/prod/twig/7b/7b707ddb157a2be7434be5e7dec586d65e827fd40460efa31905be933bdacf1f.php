...
/* __string_template__d316d4aff074a05cb4c803ddc078e9d5093057f6b4a445f6e8116f23e7c2b616 */
class __TwigTemplate_a97d40eb2c7b8391a80f6e5cf277281cd856122aca6a2e046d0c012d1975f57d extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Waterkloof Astraeus Chardon Reserve Brut</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
涼地区エルギンよりオーガニックブドウを購入。土壌はテーブルマウンテン砂岩。この土は、ワインにミネラル分を与える。ブドウは全房でバスケット・プレス。600Lの古樽で天然発酵。その後、澱が入ったまま9ヶ月熟成。その後、瓶内で2次発酵後2年熟成。デゴルジュマン（澱引き）後、更に6ヶ月熟成して出荷。<br>ワインに複雑味を加えるために、2009ヴィンテージのシャルドネMCCを15％混ぜている。<br>フレッシュで豊かな酸味、程よいボディ。泡は綺麗でキメ細やか。リッチで複雑な面もある。フィニッシュはドライで爽やか。全体には心地良い爽やかなワインで上品なスタイル。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__d316d4aff074a05cb4c803ddc078e9d5093057f6b4a445f6e8116f23e7c2b616";
    }
    ...
    {
        return new Source("", "__string_template__d316d4aff074a05cb4c803ddc078e9d5093057f6b4a445f6e8116f23e7c2b616", "");
    }
}
