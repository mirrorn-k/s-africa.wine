...
/* __string_template__0147970df3701bf8dd938c69cc272e781db28e84613ee118cefd92eaf3c0c3d9 */
class __TwigTemplate_7b2de64201c486991eeb5d0075887795997e52b44cfcf4aead074b58b0374d3b extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Longridge Emily</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2018’] 2017VT：90 Point<br>
[Platter SA 2018’] 2017VT：4.0 STAR
            </td>
        </tr>
...
樽熟成していないシャルドネと、ほんの少しだけ樽熟成させたエルギン産のピノノワールを混ぜている。両方のブドウとも全房でプレス、天然発酵、熟成。熟したグアバ、パイナップル、キウイ、青リンゴ、ストロベリーなどのフレッシュで豊かな香り。爽やかで豊かな酸、フルーティで優しいボディ。酸味と果実味とのバランスが良く、気持ちの良いやや辛口のワイン。余韻も長く、ワイン単体でも楽しめる。<br>シーフードのカルパッチョやマリネ、サラダなど爽やかな料理と。
<br><br>
オーガニック。同社の中では南アフリカで最も売れているワイン。イギリス人女性のエミリーは、南アフリカのボーア（イギリス対オランダ）戦争（1899-1902年）時代に、敵であるオランダ人兵士に対しても人種の壁を越えて献身的に介護した。戦後、南アフリカでは彼女の勇気ある行動を称えた。この商品は、そんな勇気ある彼女を忘れないために作った商品。
    ...
    {
        return "__string_template__0147970df3701bf8dd938c69cc272e781db28e84613ee118cefd92eaf3c0c3d9";
    }
    ...
    {
        return new Source("", "__string_template__0147970df3701bf8dd938c69cc272e781db28e84613ee118cefd92eaf3c0c3d9", "");
    }
}
