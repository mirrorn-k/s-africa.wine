...
/* __string_template__e71e62d2552a593466a907840219ecd8e26837a00ffe7a20864361fc5897db96 */
class __TwigTemplate_345787be10a6f0472777be404fce1e8bd8e811b544235bdd744d5b27ffc7c555 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        <tr>
            <th>本体サイズ：</th>
            <td>幅595×奥行き680×高さ1215mm
            </td>
        </tr>
        <tr>
            <th>容量・重量：</th>
            <td>81kg（定格内容積：258L）</td>
        </tr>
        <tr>
            <th>本体内寸：</th>
            <td>幅500×奥行き530（最下部400）×高さ1008mm
            </td>
        </tr>
        <tr>
            <th>設定可能温度：</th>
...
今までにない棚が話題のブリリアントシリーズ、カウンター下にもすっぽり収まる70本タイプです。前面排気でビルトインが可能なので、厨房にもちょうどよくはめ込むことができます。レストランだけでなく、ご家庭でも、スライド棚は目一杯引き出すことができるので、一番奥のワインボトルまで見えます。「あのワインどこにいれたっけ？」なんて時も、ブリリアントならすぐに見つけ出し、取り出すことができます。
<br><br>
...
<img src=\"";
    ...
    {
        return "__string_template__e71e62d2552a593466a907840219ecd8e26837a00ffe7a20864361fc5897db96";
    }
    ...
    {
        return new Source("", "__string_template__e71e62d2552a593466a907840219ecd8e26837a00ffe7a20864361fc5897db96", "");
    }
}
