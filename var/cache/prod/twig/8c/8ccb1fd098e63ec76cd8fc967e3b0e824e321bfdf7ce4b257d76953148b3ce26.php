...
/* __string_template__bce020a940520833bd9409aa3517948930223027ec0eb0ba7d44d3bcac7290bc */
class __TwigTemplate_d15dfba5eed100f0f1e9e60dae014f882ae8410769a411fa9e91cdd739450cad extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>David ＆ Nadia Aristargos</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Platter SA 2017’] 2015VT：5 STAR<br>
...
スワートランドのパールダバーグの南側斜面の12の畑のブドウを使用。ほとんどは古いブッシュヴァイン。一番古いシュナンブランは1966年に植樹。1950年代に植樹された少量のセミヨンをブレンド。古い300?のフレンチバレルで熟成。br>ライム、梨、桃、スパイス、ハーブ、ハチミツなどの香り。フレッシュで豊かな酸味と果実味。ふくよかで程良い厚みとボディを擁しているが、しっかりした酸味もあり、決して重くなく、バランス良く出来ている。複雑で様々な風味とブドウのピュアな味わいを楽しむ事ができ、素直に美味しい。余韻は長くエレガントなフィニッシュ。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__bce020a940520833bd9409aa3517948930223027ec0eb0ba7d44d3bcac7290bc";
    }
    ...
    {
        return new Source("", "__string_template__bce020a940520833bd9409aa3517948930223027ec0eb0ba7d44d3bcac7290bc", "");
    }
}
