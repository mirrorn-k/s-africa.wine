...
/* __string_template__4f9c972ecfa99855f4e98b17b9b6de27b76738f88c5d1fd85ad5099c5c8e286d */
class __TwigTemplate_8fcec6a7520c1e4ca019ebdeb70ba74a07b9b348f5f3e96bded6070594500a37 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellenrust Chenin Blanc Sparkling Brut</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
ボタラリー・ヒルズの風化した花崗岩質の畑で15-32年のブッシュヴァイン・シュナンブランと、同じボタラリー・ヒルズの花崗岩質のマスカット・オブ・アレキサンドリアのブッシュヴァインのブドウを使用。<br>朝早くに収穫。ブドウは全房で優しくプレス。ステンレスタンクで発酵し、3ヶ月熟成。シャルマ方式でタンク内二次発酵。ボトリング前にマスカット・オブ・アレキサンドリアをブレンド。青リンゴ、ライム、柑橘類など、フレッシュな果実の香り。爽やかで優しい酸味、フルーティで柔らかな泡。ふくよかで、ほんのりリッチ、ライムや柑橘類などの風味も豊かで心地良いワイン。<br>南アフリカを代表するシュナンブランの生産者、ステレンラスト社のグッドバリューなスパークリング。<br>生カキ、シーフード、スパイス料理、サラダ、パスタなど。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__4f9c972ecfa99855f4e98b17b9b6de27b76738f88c5d1fd85ad5099c5c8e286d";
    }
    ...
    {
        return new Source("", "__string_template__4f9c972ecfa99855f4e98b17b9b6de27b76738f88c5d1fd85ad5099c5c8e286d", "");
    }
}
