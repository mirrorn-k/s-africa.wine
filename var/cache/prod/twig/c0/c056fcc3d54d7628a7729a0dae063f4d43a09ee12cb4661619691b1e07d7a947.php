...
/* __string_template__f56e435ec838a2ad8d4bd4c0ecd97ecb4758132dac108594353dd7dcf5510cad */
class __TwigTemplate_805001072aede0935e54bc43441e1c898cd716068c9e63eb19e841e1c730b859 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Porcupine Ridge Syrah</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Decanter World Wine Awards 2018’] 2017VT：88 Point／Bronze<br>
[Decanter World Wine Awards 2017’] 2016VT：92 Point／Silver<br>
[Tim Atkin Report 2019’] 2018VT：89 Point<br>
[Platter SA 2020’] 2018VT：3.5 STAR<br>
...
スワートランド地区の灌漑なしの畑のブドウを使用。製造は出来るだけ手を加えないミニマリスト的アプローチ。ステンレスタンクで発酵後、果実味を表現する為に古いフレンチオークで熟成。<br>スミレ、ブラックチェリーなど、しっかりとした香りに白コショウの風味。比較的豊な酸とジューシーでなめらか、フルーティな口あたり。細やかで適度な渋みを伴い、ワインの重さも程よく感じる。全体にエレガントで複雑味もあり、バランス良くまとまっている。<br>
日々 愛用されるテーブルワインをテーマに、畑の人気者 ハリネズミをモチーフとしている。
    ...
    {
        return "__string_template__f56e435ec838a2ad8d4bd4c0ecd97ecb4758132dac108594353dd7dcf5510cad";
    }
    ...
    {
        return new Source("", "__string_template__f56e435ec838a2ad8d4bd4c0ecd97ecb4758132dac108594353dd7dcf5510cad", "");
    }
}
