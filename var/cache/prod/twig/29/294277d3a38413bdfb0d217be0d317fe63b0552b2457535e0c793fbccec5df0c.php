...
/* __string_template__8e44504248293648afd6f16655b180366b5e7721019451e79bad69f409cc20f5 */
class __TwigTemplate_659a4192b07fed51545eaca2cbea86afd6823a9d88d9e439952f9c88dfabe306 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Catherine Marshall Sauvignon Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2019’] 2018VT：91 Point<br>
...
畑は南東向き斜面で、土壌は砂岩と頁岩。収穫後プレスし、ステンレスタンクで発酵。その後、澱が入ったまま６か月熟成（シュールリー）。５％オーク樽で発酵熟成したものを４か月後にブレンド。<br>熟成ポテンシャル：ヴィンテージ+5-8年。<br>料理：サラダ、グリーンアスパラ、ホタテ、グリルした魚、エビ、寿司、タイカレーなど。<br>ライム、柑橘類、マンゴ、パッションフルーツ、グースベリーなどの香り。<br>冷涼なエルギンらしい豊かで心地良い酸味に風味も豊か。口あたりは、爽やかでクリスピー、なめらかで、ほんのりリッチ。ライムシャーベット、グレープフルーツ、白桃や青りんごなど豊かな風味が広がり、フルーティで余韻も長く、エレガントなスタイル。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__8e44504248293648afd6f16655b180366b5e7721019451e79bad69f409cc20f5";
    }
    ...
    {
        return new Source("", "__string_template__8e44504248293648afd6f16655b180366b5e7721019451e79bad69f409cc20f5", "");
    }
}
