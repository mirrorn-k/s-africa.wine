...
/* __string_template__374d943dcf964b22570a72f556a530af8bf61a73f470c0376cae58df2450d57e */
class __TwigTemplate_bbdd837be220a3a671134c677d93251ab22741001b09cd1fdea898aff140da93 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Porcupine Ridge Rose</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
フレッシュで活き活きとしたフルーティなロゼをイメージして比較的若い樹齢のブドウをメインに使用。セニエ式。収穫後、冷却、ステンレスタンクで発酵＆熟成。明るい透明感のあるサーモンピンク。<br>ピンクグレープフルーツ、スイカ、ザクロ、ライム、チェリー、ピンクペッパーなどの香り。フレッシュな酸、フルーティで程よくしっかりしたボディ、酸と果実味のバランスが良く心地良いワイン。余韻は長くドライなフィニッシュ。爽やかでフルーティ、春、夏、アウトドア、テラスなどで楽しみたい。<br>サーモン、シーフードのマリネ、ギョウザ、春巻き、中華料理、鶏肉料理、サラダ、アジア系料理など。<br>
日々 愛用されるテーブルワインをテーマに、畑の人気者 ハリネズミをモチーフとしている。
    ...
    {
        return "__string_template__374d943dcf964b22570a72f556a530af8bf61a73f470c0376cae58df2450d57e";
    }
    ...
    {
        return new Source("", "__string_template__374d943dcf964b22570a72f556a530af8bf61a73f470c0376cae58df2450d57e", "");
    }
}
