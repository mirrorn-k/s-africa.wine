...
/* __string_template__f2ae7f8fc8116e367e04d3de167d761f0731d646fad0fe2fca729cdae3a17be7 */
class __TwigTemplate_72564d3a6a70505d847dc56545e1a0fbe9d1f62173b662f3d1f79fbf00fc832b extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellenrust Artisons Apprentice White Cinsault</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Platter SA 2019’] 2017VT：4.5 STAR<br>
...
ステレンラストの若手醸造家、ヘルマンが、このワインで2019年南アフリカ最優秀若手醸造家に選ばれたアイテム。ボタラリー・ヒルズの畑で1964年に植樹。分解した花崗岩土壌。サンソーの中に、突然変異で白や薄いピンク色になったブドウだけを収穫。全房で伝統的なバスケットプレスで優しく圧搾。色が着く前のフリーランジュース（一番搾り）のみを225Ｌの４年目のフレンチオークに移して天然発酵、そのまま９ヶ月熟成。新樽使用30％。残りは2-4年目の樽使用。生産量150ケースのみの限定品。<br>アプリコット、梨、白桃、キャンディ、アーモンド、白い花などの香り。豊かな酸、程よい中庸なボディ、なめらかでリッチな味わい。フレッシュ＆フルーティ、濃厚な果実味がしっかりした酸に支えられ、バランス良くまとまっている。<br>他のステレンラストの白ワインと同じく、完熟ブドウの糖度の高い果実の甘みと酸のコントラストが、何処にも無いステレンラストらしい面白さを表現している。美しいエレガントなワインで、ピュアなブドウジュースの味を楽しめる。「白いサンソー」という珍しさだけでなく、純粋に白ワインとしても十分に秀逸な美しいワイン。<br>サーモン、グリルした魚、シーフード、バーニャカウダー、野菜料理、レモンバターソースなど。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__f2ae7f8fc8116e367e04d3de167d761f0731d646fad0fe2fca729cdae3a17be7";
    }
    ...
    {
        return new Source("", "__string_template__f2ae7f8fc8116e367e04d3de167d761f0731d646fad0fe2fca729cdae3a17be7", "");
    }
}
