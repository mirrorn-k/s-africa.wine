...
/* __string_template__8b7b72d148960755925b86bf6d3be313575be9bdc5488d73f1c3541eb526f093 */
class __TwigTemplate_be184812d17e354559a23c94af5d4a85a476ee409240ba453baffd067e19ebcd extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
\t<h2><small>Kanonkop Kadette Pinotage</small></h2>
\t<table>
\t\t<tr>
\t\t\t<th>ワイナリー：</th>
\t\t\t<td>";
...
\t\t<tr>
\t\t\t<th>受賞／評価：</th>
\t\t\t<td>[Tim Atkin Report 2019’] 2017VT：92 Point<br>
...
\t灌漑は補助的に。収穫量6-7トン/ha（38.5-45.5ｈL）、樹齢5-20年。オープンタンクで発酵。225Lのフレンチオークの2-3年目の樽で14ヶ月熟成。<br>赤い果実、プラム、チョコレートなどの香り。なめらかで心地良い酸味、凝縮した果実味、程良くしっかりしたボディ。細やかで上品な渋み。エレガントなスタイル。フィニッシュはドライで余韻も長い。カデットとは「士官候補生」。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__8b7b72d148960755925b86bf6d3be313575be9bdc5488d73f1c3541eb526f093";
    }
    ...
    {
        return new Source("", "__string_template__8b7b72d148960755925b86bf6d3be313575be9bdc5488d73f1c3541eb526f093", "");
    }
}
