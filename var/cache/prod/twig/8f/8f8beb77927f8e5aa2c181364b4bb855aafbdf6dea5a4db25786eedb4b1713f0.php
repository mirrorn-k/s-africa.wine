...
/* __string_template__1e56bfb8a4a74fc5a870dfc39bfd0648d824468b2b9f64f7081f5a0014a7763a */
class __TwigTemplate_d2c8ba3ccc3fe54b1c22860e2e3337d36079b147a8a160fc16ca2cf955267ea4 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Peacock Wild Ferment Sauvignon Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
周辺の畑で、収穫量の少ない良質のブドウを購入。収穫後は除梗せず、ソフトにプレス。フリーランジュース（一番搾り）のみ使用。６ヶ月かけてゆっくりと天然発酵＆更に１ヶ月熟成。少量のＳＯ２以外何も使用しない不干渉主義な製法。<br>ピーマン、ライムなどの香り。フレッシュで豊かな酸味、ふくよかでなめらか、複雑味と伸びがあり余韻まで続く。そのままでも美味しく、料理とのマッチングも良い。<br>不干渉主義。ピーコックという名は、ウォータークルーフの敷地内および周辺にはクジャクが生息していることから名付けられた。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__1e56bfb8a4a74fc5a870dfc39bfd0648d824468b2b9f64f7081f5a0014a7763a";
    }
    ...
    {
        return new Source("", "__string_template__1e56bfb8a4a74fc5a870dfc39bfd0648d824468b2b9f64f7081f5a0014a7763a", "");
    }
}
