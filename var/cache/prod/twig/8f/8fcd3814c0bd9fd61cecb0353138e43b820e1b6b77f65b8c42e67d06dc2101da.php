...
/* __string_template__283de5765f867527bb953d5a657858adee5378a5d74db07d1683e64bfefba16c */
class __TwigTemplate_c3a19b08bc7778147d89268eea84b0b318b2c61262792a4f4b47895ed38767e8 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Ataraxia Sauvignon Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2019’] 2018VT：92 Point
            </td>
        </tr>
...
早朝の涼しい時間に収穫。ステンレスタンクで発酵し、熟成。パッションフルーツ、柑橘類、メロン、ハーブなどの香り。活き活きとした豊かな酸、太く厚みのあるボディ、凝縮した果実味とミネラルの要素を強く感じ、バランス良く、エレガントに仕上がっている。<br>南アフリカの他の地域や生産者では感じない、アタラクシアらしいテロワールを忠実に表現した独特の個性を感じさせる。しっかりした酸味と果実味、ボディと豊かなミネラルは、どの要素もキャッチーで、誰にも分かりやすいアタラクシアの魅力。他にない魅力溢れる素晴らしいソーヴィニョンブラン。<br>シーフード、サーモン、白身魚、鶏肉料理、クリームソースの料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__283de5765f867527bb953d5a657858adee5378a5d74db07d1683e64bfefba16c";
    }
    ...
    {
        return new Source("", "__string_template__283de5765f867527bb953d5a657858adee5378a5d74db07d1683e64bfefba16c", "");
    }
}
