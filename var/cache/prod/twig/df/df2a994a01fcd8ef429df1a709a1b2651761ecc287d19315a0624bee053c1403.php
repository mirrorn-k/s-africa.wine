...
/* __string_template__55811a181340fd9970129216e5900134194fda25c00a5b0544aa1bd7ead16e64 */
class __TwigTemplate_10543c5f091c2cb7e1f0d69fdfd4bf56c95a8127cd90a1bba85dab8c19e67c5a extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Keermont Terrasse</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Parker Wine Advocate] 2015VT：94 Point<br>
[Parker Wine Advocate] 2014VT：94 Point<br>
[Tim Atkin Report 2018’] 2016VT：93 Point<br>
[Tim Atkin Report 2017’] 2015VT：93 Point<br>
[Tim Atkin Report 2016’] 2014VT：94 Point<br>
...
1971年に植樹された「リバーサイド」と呼ばれる畑のシュナンブラン（樹齢49年）が主になっている白のブレンド。発酵は中古のフレンチオークの天然発酵。後、澱（おり）が入ったまま12ヶ月熟成（シュール・リー製法）。一部ステンレスタンクで発酵、熟成させた物をブレンド。濾過せずに瓶詰め。<br>花、ナッツ、レモングラス、バタースコッチなどの香り。<br>フレッシュで綺麗な酸、凝縮した果実味、やや濃厚でなめらか、クリーミーでリッチな味わい。熟した柑橘類、洋ナシなどの風味。余韻は長くドライなフィニッシュ。様々な品種の風味と味わいが複雑に絡み合い、このワインを面白くしている。<br>2017年のヴィンテージでは、若いリバーサイドのブドウ園からマルサンヌとルーサンヌのが少量ブレンドされておりワインに丸みとボリュームを与えている。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__55811a181340fd9970129216e5900134194fda25c00a5b0544aa1bd7ead16e64";
    }
    ...
    {
        return new Source("", "__string_template__55811a181340fd9970129216e5900134194fda25c00a5b0544aa1bd7ead16e64", "");
    }
}
