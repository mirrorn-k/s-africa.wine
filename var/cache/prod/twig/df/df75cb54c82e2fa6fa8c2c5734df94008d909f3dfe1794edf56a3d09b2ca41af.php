...
/* __string_template__24d79bd24fe2908562aed56a037b099bdc87ab5d4163ac0b3b9c2bf20171a652 */
class __TwigTemplate_1a482b94375164e80a7ef4933524d19f12f53d31bfa7fd443f8c9518ca92472a extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Raats Family Cabernet Franc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2017’] 2015VT：93 Point<br>
[Tim Atkin Report 2016’] 2013VT：93 Point<br>
2015南アフリカ・トップ100ワイン選出。2015ジョン・プラッター（南ア）4.5星。ワインアドヴォケート（2014年10月号）で91点。クリスチャン・イーズ95点（2014年10月）。<br>
...
ブラックベリー、カシス、チェリー、オークやスパイスなど、複雑な香り。豊かな酸味、濃厚でジューシー、キメ細やかでなめらか、フィニッシュに向かってブルーベリー、シナモン、ダークチョコレートなどの風味も感じられる。渋みは細やかでしっかり。余韻も長く、綺麗でエレガントなワイン。<br>
お勧め料理：牛肉のカルパッチョ、マグロの刺身、ローストビーフ、羊肉など。
    ...
    {
        return "__string_template__24d79bd24fe2908562aed56a037b099bdc87ab5d4163ac0b3b9c2bf20171a652";
    }
    ...
    {
        return new Source("", "__string_template__24d79bd24fe2908562aed56a037b099bdc87ab5d4163ac0b3b9c2bf20171a652", "");
    }
}
