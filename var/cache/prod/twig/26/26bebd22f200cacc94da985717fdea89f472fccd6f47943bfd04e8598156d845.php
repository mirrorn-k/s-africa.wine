...
/* __string_template__bf0020f6626302352c54af984182ca003c6e12c5b7ce0d6da6a3ccf5c2e1dca2 */
class __TwigTemplate_d0e09ea3a325b3a3eb95dc06cd2bb7a8b3aaf6c39f2a4b4f91802cf2daee8e47 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>B Vintners Black Bream Pinot Noir</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
収穫量：6-8トン/ha。畑は海に近く、標高も３５０mの所にあり、冷涼な気候。土壌は石灰岩質。このような土壌、海に近いロケーション、標高の高さ、これらのコンディションにより高品質なピノノワールが誕生した。発酵後は、フレンチオークで熟成。ヴィンテージ+5-8年。Bヴィントナーズのユニークな地域の畑シリーズ。<br>ブラック・ブリームの名前の由来は、南アフリカの国魚（National Fish, \"Galjoen\")の別名で、この魚は近づくのが危険な波の洗いサンゴ礁の浅瀬に生息している。いわゆる天然の要害のような場所で、魚にとっては天国のような所。このブラックブリームの畑もアクセスの悪い、秘境のような所で、マイクロクライメート（微細気候）により、この地域独特のテロワールを表現している。<br>鶏肉、鴨肉、豚肉、マッシュルームを使った料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__bf0020f6626302352c54af984182ca003c6e12c5b7ce0d6da6a3ccf5c2e1dca2";
    }
    ...
    {
        return new Source("", "__string_template__bf0020f6626302352c54af984182ca003c6e12c5b7ce0d6da6a3ccf5c2e1dca2", "");
    }
}
