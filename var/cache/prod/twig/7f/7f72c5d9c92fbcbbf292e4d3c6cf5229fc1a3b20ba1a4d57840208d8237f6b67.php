...
/* __string_template__bcf074ef104f5045611fa90c4b68fee0b14c7871b488b6577bbf32be9da068a5 */
class __TwigTemplate_bb0f7c6c8e7e16208a91b0183f219549c91384f8f7e47b7d5a4f9875eb04f76f extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Hartenberg Cabernet Sauvignon Shiraz</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Platter SA 2018’] 2015VT：4 STAR<br>
[Tim Atkin Report 2017’] 2014VT：90 Point<br>
[Parker Wine Advocate] 2010VT：90 Point<br>
[Sakura Awards 2017’] 2013VT：Double Gold
            </td>
        </tr>
...
発酵後、フレンチオーク（3年目樽12％、4年目樽88％）で16ヶ月熟成。ラズベリー、カシスなど熟した赤い果実、スパイスなどの香り。柔らかな酸味、渋みは細やかで、程よいボディ感。なめらかでシルキーな口あたりが最後まで続く。長い余韻。<br>ピザ、グリルした肉料理、ビーフシチュー、焼き魚、洋ナシの赤ワイン煮など様々な料理に。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__bcf074ef104f5045611fa90c4b68fee0b14c7871b488b6577bbf32be9da068a5";
    }
    ...
    {
        return new Source("", "__string_template__bcf074ef104f5045611fa90c4b68fee0b14c7871b488b6577bbf32be9da068a5", "");
    }
}
