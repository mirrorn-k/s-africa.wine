...
/* __string_template__55c6fa92a69f1c89abe85a2ff152a6ad6eff2d04dff8da618fbda2bbe61a4c38 */
class __TwigTemplate_f892db8dc2ea0039b400aa2e875beb0c69e8c7827a86b9a23fcf3131f5c74f0e extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Longridge Chardonnay</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2017’] 2016VT：93 Point<br>
[Platter SA 2018’] 2016VT：4.0 STAR
            </td>
        </tr>
...
早朝の涼しい時間に収穫。全房でプレス。ステンレスタンクで天然発酵後、マロラクティック発酵を経て、フレンチオークに移して熟成12ヵ月。最初の6-9か月はSO2はほとんど使用しない。<br>柑橘類やライム、洋ナシなどの香り。フレッシュで豊かな酸、ボディは中庸、ドライでクラシックなスタイル。酸と果実味のバランスが良く、フレッシュな風味は最後まで続き、余韻も長い。ステレンボシュ地区では最も冷涼なヘルダーバーグらしいナチュラルな酸のバランスが取れた素晴らしいシャルドネ。<br>シーフードのグリルやマリネ、パスタ、クリームソースを使った料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__55c6fa92a69f1c89abe85a2ff152a6ad6eff2d04dff8da618fbda2bbe61a4c38";
    }
    ...
    {
        return new Source("", "__string_template__55c6fa92a69f1c89abe85a2ff152a6ad6eff2d04dff8da618fbda2bbe61a4c38", "");
    }
}
