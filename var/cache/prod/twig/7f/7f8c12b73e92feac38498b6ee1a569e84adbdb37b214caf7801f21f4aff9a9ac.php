...
/* __string_template__e60c99cd27498dae5e4a030786137f0885422620a21e8ae9f38be7fb73bc6ddf */
class __TwigTemplate_448deda5a2ad30f479a125646d0d0a74cbe6956239f531d50e6abf9df57cae6f extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Stellar Running Duck Non Sulpher Added Pinotage</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Ultra Vulalue Challenge 2018’] 2018VT：Gold
            </td>
        </tr>
...
ステンレスタンクで発酵、熟成。ボトリングの際に窒素ガスを注入して酸化を防いでいる。<br>チェリー、プラム、タバコなどの香り。優しい柔らかな酸とボディ。フレッシュで赤系果実やプラムなどのフルーティでジューシーな味わい。渋みは程よい程度で、軽快でなめらか、優しい口あたりで飲みやすい。<br>ローストビーフ、ローストポーク、赤身の牛肉、チーズカレー、スパイス系料理、アジア系料理、中華料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__e60c99cd27498dae5e4a030786137f0885422620a21e8ae9f38be7fb73bc6ddf";
    }
    ...
    {
        return new Source("", "__string_template__e60c99cd27498dae5e4a030786137f0885422620a21e8ae9f38be7fb73bc6ddf", "");
    }
}
