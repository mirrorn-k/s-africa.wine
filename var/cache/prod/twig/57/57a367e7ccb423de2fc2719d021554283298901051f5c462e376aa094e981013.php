...
/* __string_template__e4435b76003f5682cd86c81c500067c790e1c6bebb0dcaa07af9c56ab1ae462f */
class __TwigTemplate_b94fb48d09f83eabd7a7a73447cb9579a1e130a4fe1177ae88c86207730c2343 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Longridge Organic Chenin Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
ステレンボシュ地区で最も冷涼なヘルダーバーグ山脈の麓の斜面。この地区は大西洋のフォルス湾から冷涼な風が吹いてきて、夜も冷える。その結果、ブドウはゆっくりと生長し、自然に酸がしっかりと含まれる。ブドウは全房で天然発酵。発酵はフレンチオークで10-14日、時々バトナージュ。そのまま11ヶ月熟成（新樽と中古樽）。無ろ過で瓶詰め。無濾過で自然な醸造方法で製造しているので酒石などが発生する場合がありますが無害です。<br>メロン、白桃、濃厚な柑橘類、ライム、香水、ナッツなど、複雑で豊かな香り。フレッシュな酸、優しくふくよかなボディ、全体のバランスも取れていて、なめらかな味わい。フレッシュ＆フルーティな、シンプルに素直に美味しく楽しめる。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__e4435b76003f5682cd86c81c500067c790e1c6bebb0dcaa07af9c56ab1ae462f";
    }
    ...
    {
        return new Source("", "__string_template__e4435b76003f5682cd86c81c500067c790e1c6bebb0dcaa07af9c56ab1ae462f", "");
    }
}
