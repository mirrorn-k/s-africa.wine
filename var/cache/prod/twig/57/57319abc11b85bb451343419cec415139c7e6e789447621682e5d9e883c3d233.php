...
/* __string_template__ae740bea93a2a07d87c482d2f23f06c87d07bf13c9e78f48715300d87d98b653 */
class __TwigTemplate_64cb2a3fd5f95bac4e7aa04d5f59a807f8abd921d7f56c3da4a226f4d003025d extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Peacock Wild Ferment Syrah</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
周辺の畑で、収穫量の少ない良質のブドウを購入。収穫後は除梗せず、ソフトにプレス。600Lの古いフレンチオークと、大きな古いオークカスクで天然発酵＆熟成6ヶ月。軽くフィルターをして瓶詰め。少量のSO2以外何も使用しない不干渉主義な製法。<br>チェリー、プラム、スパイスなどの香り。フレッシュで豊かな酸味、ジューシーな果実味は酸とのバランスが良く、シルキーで綺麗なワインに仕上がっている。そのままでも美味しく、料理とのマッチングも良い。不干渉主義。<br>ピーコックという名は、ウォータークルーフの敷地内および周辺にはクジャクが生息していることから名付けられた。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__ae740bea93a2a07d87c482d2f23f06c87d07bf13c9e78f48715300d87d98b653";
    }
    ...
    {
        return new Source("", "__string_template__ae740bea93a2a07d87c482d2f23f06c87d07bf13c9e78f48715300d87d98b653", "");
    }
}
