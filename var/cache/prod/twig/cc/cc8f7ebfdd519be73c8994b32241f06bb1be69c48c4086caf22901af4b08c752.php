...
/* Block/constantia_glen.twig */
class __TwigTemplate_849ccb19403e7597c7bc53277bd906615e459529d552560648ac07a59593d3bc extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-9\">
            ...
            <h3 class=\"ltx_15 tx_bld\">
南アフリカワイン発祥の地コンスタンシア</h3>
            <p class=\"m_5\">南アフリカで最初にブドウ栽培が始まった（1685年）コンスタンシア地区にある。「グレン」とは、「谷」を意味する。<br>冷たい大西洋に囲まれ冷涼で、比較的降水量も多い。冷涼コンスタンシア地区のボルドー品種を使った優等生的な生産者。冷涼気候によりブドウはゆっくりと成長。一粒ずつの厳選なブドウ選果とポンプを使わないグラヴィティ・システムを採用。白も赤もフレッシュで豊かな酸味、しっかりした骨格とボディ、洗練されたエレガントで美しいワインを生み出している。<br>同社ワインのキーワードは、「エレガンス、フィネス（洗練された）、バランス、コンプレックス（複雑味）」。</p>
        </div>
        ";
                        }
                        // line 21
    ...
    {
        return "Block/constantia_glen.twig";
    }
    ...
    {
        return new Source("", "Block/constantia_glen.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/constantia_glen.twig");
    }
}
