...
/* __string_template__4052910a755143b310c27acf2e10878b76b34b36a9d7046a6bbd4ae6c40b1a80 */
class __TwigTemplate_3e4818ebe649ab4bdaa5d0bb8c9768ce77be64bc0eae2d4733ee3897ddafb601 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Constantia Glen Three</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2018’] 2014VT：93 Point<br>
...
それぞれの品種ごとに発酵、フレンチオークで17ヵ月熟成。新樽28％使用。2年目樽60％、3年目樽は12％使用。軽くフィルターして瓶詰。更に瓶熟成を2年してからリリース。生産量46,000本。<br>赤系、黒系の果実、熟した果実、ドライハーブ、鉛筆の芯、白コショウやスパイスなどの香り。美しく豊かな酸味、凝縮し深みのある果実味、柔らかさと程良いボディを兼ね備え、渋みは細やかで洗練されている。味わいはリッチでなめらか、フルーティかつエレガントな風味がこのワイン全体を包み込み、上品に仕上げている。3つの品種が見事に調和し、バランスのとれた美しいワイン。コストパフォーマンスに優れ、ボルドー右岸系のブレンドの替わりとして提案できる。<br>赤身の牛肉、ローストした羊肉、ラムチョップ、鴨肉、ローストポーク、焼き野菜など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__4052910a755143b310c27acf2e10878b76b34b36a9d7046a6bbd4ae6c40b1a80";
    }
    ...
    {
        return new Source("", "__string_template__4052910a755143b310c27acf2e10878b76b34b36a9d7046a6bbd4ae6c40b1a80", "");
    }
}
