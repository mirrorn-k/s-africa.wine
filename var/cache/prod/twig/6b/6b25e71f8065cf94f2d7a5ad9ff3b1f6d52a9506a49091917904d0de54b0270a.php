...
/* Block/stellar.twig */
class __TwigTemplate_af674b7a18b8e6fc6dc5e86ae47a8c573bfbfcb363505334d9a826c0e064c47a extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-9\">
            ...
            <h3 class=\"ltx_15 tx_bld\">
オーガニックだからと言って品質に妥協はない</h3>
            <p class=\"m_5\">「オーガニックだからと言って品質に妥協はない」<br>そのポリシーのもと、オーガニックワイン生産者としても毎年数多くのメダルを受賞しているステラーオーガニック社。ステラー社はオーガニックワインの生産者（コントロール・ユニオン・サーティフィケーションズ：オランダの認証）でかつ、フェアトレードの認証を取得した世界初のワイナリー。</p>
        </div>
        ";
                        }
                        // line 21
    ...
    {
        return new Source("", "Block/stellar.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/stellar.twig");
    }
}
