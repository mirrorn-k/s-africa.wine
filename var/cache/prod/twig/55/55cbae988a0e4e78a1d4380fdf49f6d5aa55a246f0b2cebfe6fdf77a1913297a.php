...
/* __string_template__44fe8dc73e560df68f5074793ed09bd0b9e2b9867b1736058a020826de059e66 */
class __TwigTemplate_3f0792aae57b4ba39c8bebd9942077f6c2ac6e6c953ca8633079ba63806b062e extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
\t灌漑は補助的に、収穫量7トン/ha（45.5ｈL）樹齢5-30年。オープンタンクで発酵。225Lのフレンチオークの2-3年目の樽で12-14ヶ月熟成。<br>熟したラズベリー、モカ、プラムなどの香り。なめらかで心地良い酸味、凝縮した果実味、程良くしっかりしたボディ。ダークチョコレートやブラックベリーの風味。様々な品種が複雑に表現され、かつ調和がとれている。フィニッシュはドライで余韻も長い。カデットとは「士官候補生」。
    ...
    {
        return "__string_template__44fe8dc73e560df68f5074793ed09bd0b9e2b9867b1736058a020826de059e66";
    }
    ...
    {
        return new Source("", "__string_template__44fe8dc73e560df68f5074793ed09bd0b9e2b9867b1736058a020826de059e66", "");
    }
}
