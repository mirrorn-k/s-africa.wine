...
/* __string_template__0c3e21edcf5822cb6f8ce7a3b4fd1f559137afed642f3fdee09c79848ecc4a17 */
class __TwigTemplate_57b68fc1197a5f64006e963176e3637ac945c6f424f945a19ff8f3d3b0b81198 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>New Beginnings Chenin Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
ステンレスタンクで発酵後、熟成（一部樽使用）。トロピカルフルーツ、熟したライチ、洋ナシ、パイナップル、ライム、青リンゴ、白い花などの香り。フレッシュな酸、フルーティでなめらかな口あたりで、ほんのりクリーミー。飲みやすく、心地良いワインでバランス良い。青リンゴやグレープフルーツ、ミネラルの風味も感じ、トロピカルフルーツの風味が最後まで続く。<br>グリルした魚、シーフード、鶏肉、ローストした鴨、サラダ、様々な野菜料理、スパイスを使用するアジア系料理、キッシュ、山羊のチーズなど。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__0c3e21edcf5822cb6f8ce7a3b4fd1f559137afed642f3fdee09c79848ecc4a17";
    }
    ...
    {
        return new Source("", "__string_template__0c3e21edcf5822cb6f8ce7a3b4fd1f559137afed642f3fdee09c79848ecc4a17", "");
    }
}
