...
/* __string_template__ade85c2c28305b1647bbd77db183664e715d7c390dfabf6a0183f18fcea58deb */
class __TwigTemplate_b6cc04effa9b98ca4e4b64ac1ac459f0a771977f51f62eefbe781b38c6a7723b extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Jasper Raats Cuivee Rika Pinot Noir</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
[Platter SA 2017’] 2014VT：4.0 STAR
            </td>
        </tr>
...
冷涼地区エルギンのテロワールを表現するため、ミニマム・アプローチの不干渉主義でオーガニック農法で育てられたシングル畑のブドウを使用。ブドウは小さなオープンタンクで天然発酵。その後は、フレンチオークで11ヶ月熟成（新樽と中古樽）。無濾過で自然な醸造方法で製造しているので酒石などが発生する場合がありますが無害です。熟した赤系ベリー、ジューシーなストロベリー、スパイスなどの香り。優しく柔らかな酸、細やかな渋み、優しいボディで、クラシック＆エレガントなスタイル。なめらかで飲みやすいフルーティなワイン。<br>
醸造家 ジャスパー・ラーツのオリジナルブランドです。 葡萄はエルギンの買い葡萄でオーガニック。ビオディナミ製法。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__ade85c2c28305b1647bbd77db183664e715d7c390dfabf6a0183f18fcea58deb";
    }
    ...
    {
        return new Source("", "__string_template__ade85c2c28305b1647bbd77db183664e715d7c390dfabf6a0183f18fcea58deb", "");
    }
}
