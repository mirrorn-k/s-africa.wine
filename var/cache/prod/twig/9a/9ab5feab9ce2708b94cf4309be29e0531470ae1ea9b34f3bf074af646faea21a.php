...
/* __string_template__f5980d416d5318935c2b82d9f8adccc927af691fb7ea97da30fbf5ea5b2b3e6a */
class __TwigTemplate_35e110fb9502bf56c82e0b2afde73d9eb77a5e65cbc2d0dc83efefe3d4de0798 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Noble Late Harvest</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2019’] 2016VT：95 Point<br>
...
フランシュックの川に面した1997年に植樹された自社畑のオーガニック認証のある1ブロックのブドウを使用。ノーブルレイトハーベストは、毎年1樽のみ作られる貴重なワイン。遅摘み貴腐ブドウを新樽のフレンチオークで発酵、30ヶ月熟成。<br>アプリコットやパイナップル、クリーム・ブリュレ、シナモンなどの香り。酸味と甘さのバランスが良く、コクがあり、蜂蜜のような濃厚でリッチな味わい。オークの風味もあり、ゴージャスなワインに仕上がっている。ソーテルヌ・スタイル。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__f5980d416d5318935c2b82d9f8adccc927af691fb7ea97da30fbf5ea5b2b3e6a";
    }
    ...
    {
        return new Source("", "__string_template__f5980d416d5318935c2b82d9f8adccc927af691fb7ea97da30fbf5ea5b2b3e6a", "");
    }
}
