...
/* Block/rascallion.twig */
class __TwigTemplate_ea460d91610c6b9c00e5821f28b7fd9738721364e9c26bc97e61f479312e01bb extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        <div class=\"col-12 col-md-9\">
            ...
            <h3 class=\"ltx_15 tx_bld\">
\"This is not Wine, This is RASCALLION\"<small>（「これはワインではなく、ラスカリオンです」）</small></h3>
            <p class=\"m_5\">「南アフリカは、単一品種よりブレンド・ワインの方が価値が高い」という考えの下、南アフリカの様々な地区（ステレンボシュ、スワートランド、ピーケニアスクルーフ、ロバートソンなど）のワインを購入してブレンドしているネゴシアン。文字やラベルも特徴的。リーズナブルで高品質のワインを生産。</p>
        </div>
        ";
                        }
                        // line 21
    ...
    {
        return new Source("", "Block/rascallion.twig", "/home/anotherworld/www/s-africa.wine/app/template/default/Block/rascallion.twig");
    }
}
