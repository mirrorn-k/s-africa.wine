...
/* __string_template__265e7adc52c1f3c468653f6848ed759a520026827219a24d896c6e2818fb3028 */
class __TwigTemplate_9b0c6acfc961f7689764a0a7e5a7469e8ab00263cce46bfac267d8f28d65d6bc extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Constantia Glen Souvignon Blanc</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2018’] 2017VT：91 Point<br>
[Platter SA 2018’] 2017VT：5 STAR
            </td>
        </tr>
...
このワインに使われるブドウは、ベストなブロックのものを使用。早朝の涼しい時間に収穫。ブドウはプレス後、ステンレスタンクで発酵、5ヵ月熟成。２％セミヨンをブレンドしすることで、シャープな酸を抑え、少しまろやかにしている。<br>ハーブ、ライム、グレープフルーツ、白桃などの香り。美しく豊かな酸味、凝縮した果実味、ミネラルの要素、なめらかでリッチ、程良いボディ、エレガントで高級感を漂わせている。余韻は長く、クリーンで洗われるような綺麗なフィニッシュ。<br>ワインは酸味とのバランスが良く、洗練されエレガントな素晴らしいコンスタンシアの見本的なソーヴィニョンブランと言える。今でもフレッシュに楽しめるが、熟成しても楽しめるタイプなので、是非セラーに入れて欲しい。<br>グリルした魚やホタテにレモンやライムのソース、アボガド、グリーンアスパラ、イチジクとヤギのチーズ、鶏肉料理など。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__265e7adc52c1f3c468653f6848ed759a520026827219a24d896c6e2818fb3028";
    }
    ...
    {
        return new Source("", "__string_template__265e7adc52c1f3c468653f6848ed759a520026827219a24d896c6e2818fb3028", "");
    }
}
