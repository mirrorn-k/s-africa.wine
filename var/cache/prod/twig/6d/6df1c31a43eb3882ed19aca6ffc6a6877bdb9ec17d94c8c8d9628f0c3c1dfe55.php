...
/* __string_template__0ca3b2855f6936ad27e75f45066ffbc7a88933c37f19a9eb48d10fcfa1fd3123 */
class __TwigTemplate_af0a16db238ab90987f900fa139177f0f2a1ea927ba3093bd818c7af035cbeea extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>B Vintners Liberte Pinotage</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
[Platter SA 2019’] 2017VT：4.5 STAR
            </td>
        </tr>
...
海に近い高地の古い樹齢の畑のブドウを使用。不干渉主義アプローチ。フレッシュなチェリー、ブルーベリー、ドライハーブ、スパイス、カカオ、コーヒーなどの香り。しっかりと豊かな酸味、凝縮した果実味、程良い渋み、複雑で、フレッシュなブドウの味を最大限かつ洗練された形で表現し、なめらかでエレガントに仕上げている。濃厚で重いタイプのピノタージュとは違う、ソフトでピノノワールのニュアンスもあるクラシックなスタイル。改めてピノタージュという品種の幅を広げ、その魅力を伝えることができる1本。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__0ca3b2855f6936ad27e75f45066ffbc7a88933c37f19a9eb48d10fcfa1fd3123";
    }
    ...
    {
        return new Source("", "__string_template__0ca3b2855f6936ad27e75f45066ffbc7a88933c37f19a9eb48d10fcfa1fd3123", "");
    }
}
