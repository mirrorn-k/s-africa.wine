...
/* __string_template__d3587ac72cd2bd2cf0cb0c3028cedb31a0b6684d2e955c87630faea0c624c6d2 */
class __TwigTemplate_848c5dfd2e7e0db8bb784baf579fe3f70d516d61e6c4872c0f1798ad1929b29a extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Aristea MCC Rose</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
";
        ...
        <tr>
            <th>受賞／評価：</th>
            <td>[Tim Atkin Report 2018’] 2016VT：91 Point
            </td>
        </tr>
...
ゆっくりと優しく全房でプレス。一番搾りとベストなジュースのみ使用。発酵後、マロラクティック発酵を経て、ベースとなるワインが完成。全てのワインをブレンドして瓶詰し、2次発酵。瓶内で最低2年熟成。生産量4000本。<br>色は繊細なサーモンピンク。赤いベリー系、ストロベリー、チェリーなど、フレッシュでチャーミングな果実の香り。活き活きとした豊かな酸味は最初から最後まで続く。細やかで上品、優しいムースのような美しい泡が長く続き、かつ複雑で深みもある。ゴージャスだけど派手すぎない、クラシックでエレガントなスタイル。南アフリカのMCCスパークリングとしては素晴らしい1本。<br>サーモン、エビ、カルパッチョなどの前菜に、また、牛肉などのメイン料理に、イチゴと一緒にデザートに多彩に対応できる。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__d3587ac72cd2bd2cf0cb0c3028cedb31a0b6684d2e955c87630faea0c624c6d2";
    }
    ...
    {
        return new Source("", "__string_template__d3587ac72cd2bd2cf0cb0c3028cedb31a0b6684d2e955c87630faea0c624c6d2", "");
    }
}
