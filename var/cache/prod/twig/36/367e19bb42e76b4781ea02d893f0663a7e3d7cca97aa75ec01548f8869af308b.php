...
/* __string_template__d969033c6d010eea6f9409c8d4c0727132c873563cfbf448e80a31ca314da331 */
class __TwigTemplate_0a5e2526ff957e11ccd1e9bf887b2e44c12565c580ed6b11bb8fba1ae820c382 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<div class=\"productsheet__table\">   <h2><small>Boekenhoutskloof Semillon</small></h2>
    <table>
        <tr>
            <th>ワイナリー：</th>
            <td>";
...
セミヨン種としては、南アフリカで最も古い樹齢の１つとされている1902年植樹のブドウと、フランシュック地区の1936年と1942年に植樹されたブッシュヴァイン（株仕立て）の３カ所から使用。古い樹齢のブドウは、収穫量が少なく、濃厚で複雑、しっかりした骨格をもたらす。ブドウは房ごとプレスし、樽と卵型のコンクリートタンクで天然発酵。その後は低温で14カ月熟成。その間SO2は入れない。マロラクティックも無し。1-2％のマスカット・オブ・アレキサンドリアをブレンド。<br>繊細でエレガントなグレープフルーツ、カモミール、リンゴの花、スパイスなどの香り。柔らかくなめらかな酸味、濃厚で凝縮した果実味、太い骨格のあるボディ。黄桃、梨、グリーンイチジクなどの豊かな風味が広がり、酸味とのバランスも良い。フィニッシュは長く、複雑、スパイス感もある。<br>飲み頃は2020-2018年頃。
</div>";
    }

    public function getTemplateName()
    {
        return "__string_template__d969033c6d010eea6f9409c8d4c0727132c873563cfbf448e80a31ca314da331";
    }
    ...
    {
        return new Source("", "__string_template__d969033c6d010eea6f9409c8d4c0727132c873563cfbf448e80a31ca314da331", "");
    }
}
